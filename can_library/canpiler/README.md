...
- **Templates** (`../templates/`): `bus_header.h.jinja`, `can_router.h.jinja`, `can_types.h.jinja`, `fault_data.c.jinja`, `fault_data.h.jinja`, `filter/bxcan.c.jinja`, `filter/fdcan.c.jinja`, `node_header.h.jinja`, plus shared `node/` partials.
