...
function(set_target_arch TARGET FAMILY)
    if(FAMILY MATCHES "F7")
        set(ARCH_FLAGS "-mcpu=cortex-m7 -mfpu=fpv5-d16 -mfloat-abi=hard")
    elseif(FAMILY MATCHES "F4" OR FAMILY MATCHES "G4" OR FAMILY MATCHES "L4")
        set(ARCH_FLAGS "-mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard")
    else()
        message(FATAL_ERROR "Unknown STM32 family: ${FAMILY}")
    endif()

    target_compile_options(${TARGET} PRIVATE ${ARCH_FLAGS})
    target_link_options(${TARGET} PRIVATE ${ARCH_FLAGS})
endfunction()
