...
uint16_t faultLatchTime[TOTAL_NUM_FAULTS] = { PDU_MCU_TEMP_HIGH_LATCH_TIME, DASH_RAIL_LATCH_TIME, ABOX_RAIL_LATCH_TIME, MAIN_RAIL_LATCH_TIME, DAQ_RAIL_LATCH_TIME, V_CRIT_LATCH_TIME,
			...
			PRECHARGE_TIME_FAULT_LATCH_TIME, MOTOR_R_HEAT_LATCH_TIME, MOTOR_L_HEAT_LATCH_TIME, MOTOR_R_OT_LATCH_TIME, MOTOR_L_OT_LATCH_TIME, APPS_WIRING_T1_LATCH_TIME, APPS_WIRING_T2_LATCH_TIME,
			BSE_LATCH_TIME, BSPD_LATCH_TIME, IMPLAUS_DETECTED_LATCH_TIME, APPS_BRAKE_LATCH_TIME, DISCHARGE_LIMIT_ENFORCE_LATCH_TIME, CHARGER_SAFETY_RELAY_LATCH_TIME, INTERNAL_HARDWARE_LATCH_TIME,
			...
			PACK_TEMP_LATCH_TIME, PACK_TEMP_EXCEEDED_LATCH_TIME, MIN_PACK_TEMP_LATCH_TIME, IMD_LATCH_TIME, TMU_POWER_LOST_LATCH_TIME, TV_DISABLED_LATCH_TIME, MM_DISABLED_LATCH_TIME,
			TV_UNCALIBRATED_LATCH_TIME, NO_GPS_FIX_LATCH_TIME, TV_ENABLED_LATCH_TIME, MM_ENABLED_LATCH_TIME, TV_CALIBRATED_LATCH_TIME, YES_GPS_FIX_LATCH_TIME, TEST_FAULT_1_LATCH_TIME,
...
uint16_t faultULatchTime[TOTAL_NUM_FAULTS] = { PDU_MCU_TEMP_HIGH_UNLATCH_TIME, DASH_RAIL_UNLATCH_TIME, ABOX_RAIL_UNLATCH_TIME, MAIN_RAIL_UNLATCH_TIME, DAQ_RAIL_UNLATCH_TIME, V_CRIT_UNLATCH_TIME,
			...
			PRECHARGE_TIME_FAULT_UNLATCH_TIME, MOTOR_R_HEAT_UNLATCH_TIME, MOTOR_L_HEAT_UNLATCH_TIME, MOTOR_R_OT_UNLATCH_TIME, MOTOR_L_OT_UNLATCH_TIME, APPS_WIRING_T1_UNLATCH_TIME, APPS_WIRING_T2_UNLATCH_TIME,
			BSE_UNLATCH_TIME, BSPD_UNLATCH_TIME, IMPLAUS_DETECTED_UNLATCH_TIME, APPS_BRAKE_UNLATCH_TIME, DISCHARGE_LIMIT_ENFORCE_UNLATCH_TIME, CHARGER_SAFETY_RELAY_UNLATCH_TIME, INTERNAL_HARDWARE_UNLATCH_TIME,
			...
			PACK_TEMP_UNLATCH_TIME, PACK_TEMP_EXCEEDED_UNLATCH_TIME, MIN_PACK_TEMP_UNLATCH_TIME, IMD_UNLATCH_TIME, TMU_POWER_LOST_UNLATCH_TIME, TV_DISABLED_UNLATCH_TIME, MM_DISABLED_UNLATCH_TIME,
			TV_UNCALIBRATED_UNLATCH_TIME, NO_GPS_FIX_UNLATCH_TIME, TV_ENABLED_UNLATCH_TIME, MM_ENABLED_UNLATCH_TIME, TV_CALIBRATED_UNLATCH_TIME, YES_GPS_FIX_UNLATCH_TIME, TEST_FAULT_1_UNLATCH_TIME,
...
fault_status_t statusArray[TOTAL_NUM_FAULTS] = {
	...
	(fault_status_t){false, ID_MM_DISABLED_FAULT},
	(fault_status_t){false, ID_TV_UNCALIBRATED_FAULT},
	(fault_status_t){false, ID_NO_GPS_FIX_FAULT},
	(fault_status_t){false, ID_TV_ENABLED_FAULT},
	(fault_status_t){false, ID_MM_ENABLED_FAULT},
	(fault_status_t){false, ID_TV_CALIBRATED_FAULT},
...
fault_attributes_t faultArray[TOTAL_NUM_FAULTS] = {
	...
	(fault_attributes_t){false, false, MCU_TEMP_HIGH_PRIORITY, 0, 0, MCU_TEMP_HIGH_MAX, MCU_TEMP_HIGH_MIN, &statusArray[14], 0, MCU_TEMP_HIGH_MSG}, 
	(fault_attributes_t){false, false, DT_L_TEMP_OT_PRIORITY, 0, 0, DT_L_TEMP_OT_MAX, DT_L_TEMP_OT_MIN, &statusArray[15], 0, DT_L_TEMP_OT_MSG}, 
	(fault_attributes_t){false, false, DT_R_TEMP_OT_PRIORITY, 0, 0, DT_R_TEMP_OT_MAX, DT_R_TEMP_OT_MIN, &statusArray[16], 0, DT_R_TEMP_OT_MSG}, 
	(fault_attributes_t){false, false, DT_L_TEMP_HIGH_PRIORITY, 0, 0, DT_L_TEMP_HIGH_MAX, DT_L_TEMP_HIGH_MIN, &statusArray[17], 0, DT_L_TEMP_HIGH_MSG}, 
	(fault_attributes_t){false, false, DT_R_TEMP_HIGH_PRIORITY, 0, 0, DT_R_TEMP_HIGH_MAX, DT_R_TEMP_HIGH_MIN, &statusArray[18], 0, DT_R_TEMP_HIGH_MSG}, 
	(fault_attributes_t){false, false, BAT_COOL_LOOP_HIGH_PRIORITY, 0, 0, BAT_COOL_LOOP_HIGH_MAX, BAT_COOL_LOOP_HIGH_MIN, &statusArray[19], 0, BAT_COOL_LOOP_HIGH_MSG}, 
	(fault_attributes_t){false, false, DT_COOL_LOOP_HIGH_PRIORITY, 0, 0, DT_COOL_LOOP_HIGH_MAX, DT_COOL_LOOP_HIGH_MIN, &statusArray[20], 0, DT_COOL_LOOP_HIGH_MSG}, 
	(fault_attributes_t){false, false, DT_R_THERM_DISC_PRIORITY, 0, 0, DT_R_THERM_DISC_MAX, DT_R_THERM_DISC_MIN, &statusArray[21], 0, DT_R_THERM_DISC_MSG}, 
	(fault_attributes_t){false, false, DT_L_THERM_DISC_PRIORITY, 0, 0, DT_L_THERM_DISC_MAX, DT_L_THERM_DISC_MIN, &statusArray[22], 0, DT_L_THERM_DISC_MSG}, 
	(fault_attributes_t){false, false, BATT_CL_DISC_PRIORITY, 0, 0, BATT_CL_DISC_MAX, BATT_CL_DISC_MIN, &statusArray[23], 0, BATT_CL_DISC_MSG}, 
	(fault_attributes_t){false, false, DT_CL_DISC_PRIORITY, 0, 0, DT_CL_DISC_MAX, DT_CL_DISC_MIN, &statusArray[24], 0, DT_CL_DISC_MSG}, 
	(fault_attributes_t){false, false, BSPD_LATCHED_PRIORITY, 0, 0, BSPD_LATCHED_MAX, BSPD_LATCHED_MIN, &statusArray[25], 0, BSPD_LATCHED_MSG}, 
	(fault_attributes_t){false, false, BOTS_FAIL_PRIORITY, 0, 0, BOTS_FAIL_MAX, BOTS_FAIL_MIN, &statusArray[26], 0, BOTS_FAIL_MSG}, 
	(fault_attributes_t){false, false, INERTIA_FAIL_PRIORITY, 0, 0, INERTIA_FAIL_MAX, INERTIA_FAIL_MIN, &statusArray[27], 0, INERTIA_FAIL_MSG}, 
	(fault_attributes_t){false, false, COCKPIT_ESTOP_PRIORITY, 0, 0, COCKPIT_ESTOP_MAX, COCKPIT_ESTOP_MIN, &statusArray[28], 0, COCKPIT_ESTOP_MSG}, 
	(fault_attributes_t){false, false, RIGHT_ESTOP_PRIORITY, 0, 0, RIGHT_ESTOP_MAX, RIGHT_ESTOP_MIN, &statusArray[29], 0, RIGHT_ESTOP_MSG}, 
	(fault_attributes_t){false, false, LEFT_ESTOP_PRIORITY, 0, 0, LEFT_ESTOP_MAX, LEFT_ESTOP_MIN, &statusArray[30], 0, LEFT_ESTOP_MSG}, 
	(fault_attributes_t){false, false, HVD_DISC_PRIORITY, 0, 0, HVD_DISC_MAX, HVD_DISC_MIN, &statusArray[31], 0, HVD_DISC_MSG}, 
	(fault_attributes_t){false, false, HUB_DISC_PRIORITY, 0, 0, HUB_DISC_MAX, HUB_DISC_MIN, &statusArray[32], 0, HUB_DISC_MSG}, 
	(fault_attributes_t){false, false, TSMS_DISC_PRIORITY, 0, 0, TSMS_DISC_MAX, TSMS_DISC_MIN, &statusArray[33], 0, TSMS_DISC_MSG}, 
	(fault_attributes_t){false, false, PRECHARGE_TIME_FAULT_PRIORITY, 0, 0, PRECHARGE_TIME_FAULT_MAX, PRECHARGE_TIME_FAULT_MIN, &statusArray[34], 0, PRECHARGE_TIME_FAULT_MSG}, 
	(fault_attributes_t){false, false, MOTOR_R_HEAT_PRIORITY, 0, 0, MOTOR_R_HEAT_MAX, MOTOR_R_HEAT_MIN, &statusArray[35], 0, MOTOR_R_HEAT_MSG}, 
	(fault_attributes_t){false, false, MOTOR_L_HEAT_PRIORITY, 0, 0, MOTOR_L_HEAT_MAX, MOTOR_L_HEAT_MIN, &statusArray[36], 0, MOTOR_L_HEAT_MSG}, 
	(fault_attributes_t){false, false, MOTOR_R_OT_PRIORITY, 0, 0, MOTOR_R_OT_MAX, MOTOR_R_OT_MIN, &statusArray[37], 0, MOTOR_R_OT_MSG}, 
	(fault_attributes_t){false, false, MOTOR_L_OT_PRIORITY, 0, 0, MOTOR_L_OT_MAX, MOTOR_L_OT_MIN, &statusArray[38], 0, MOTOR_L_OT_MSG}, 
	...
	(fault_attributes_t){false, false, APPS_WIRING_T2_PRIORITY, 0, 0, APPS_WIRING_T2_MAX, APPS_WIRING_T2_MIN, &statusArray[40], 0, APPS_WIRING_T2_MSG}, 
	(fault_attributes_t){false, false, BSE_PRIORITY, 0, 0, BSE_MAX, BSE_MIN, &statusArray[41], 0, BSE_MSG}, 
	(fault_attributes_t){false, false, BSPD_PRIORITY, 0, 0, BSPD_MAX, BSPD_MIN, &statusArray[42], 0, BSPD_MSG}, 
	(fault_attributes_t){false, false, IMPLAUS_DETECTED_PRIORITY, 0, 0, IMPLAUS_DETECTED_MAX, IMPLAUS_DETECTED_MIN, &statusArray[43], 0, IMPLAUS_DETECTED_MSG}, 
	(fault_attributes_t){false, false, APPS_BRAKE_PRIORITY, 0, 0, APPS_BRAKE_MAX, APPS_BRAKE_MIN, &statusArray[44], 0, APPS_BRAKE_MSG}, 
	(fault_attributes_t){false, false, DISCHARGE_LIMIT_ENFORCE_PRIORITY, 0, 0, DISCHARGE_LIMIT_ENFORCE_MAX, DISCHARGE_LIMIT_ENFORCE_MIN, &statusArray[45], 0, DISCHARGE_LIMIT_ENFORCE_MSG}, 
	(fault_attributes_t){false, false, CHARGER_SAFETY_RELAY_PRIORITY, 0, 0, CHARGER_SAFETY_RELAY_MAX, CHARGER_SAFETY_RELAY_MIN, &statusArray[46], 0, CHARGER_SAFETY_RELAY_MSG}, 
	(fault_attributes_t){false, false, INTERNAL_HARDWARE_PRIORITY, 0, 0, INTERNAL_HARDWARE_MAX, INTERNAL_HARDWARE_MIN, &statusArray[47], 0, INTERNAL_HARDWARE_MSG}, 
	(fault_attributes_t){false, false, HEATSINK_THERMISTOR_PRIORITY, 0, 0, HEATSINK_THERMISTOR_MAX, HEATSINK_THERMISTOR_MIN, &statusArray[48], 0, HEATSINK_THERMISTOR_MSG}, 
	(fault_attributes_t){false, false, SOFTWARE_PRIORITY, 0, 0, SOFTWARE_MAX, SOFTWARE_MIN, &statusArray[49], 0, SOFTWARE_MSG}, 
	(fault_attributes_t){false, false, MAX_CELLV_HIGH_PRIORITY, 0, 0, MAX_CELLV_HIGH_MAX, MAX_CELLV_HIGH_MIN, &statusArray[50], 0, MAX_CELLV_HIGH_MSG}, 
	(fault_attributes_t){false, false, MIN_CELLV_LOW_PRIORITY, 0, 0, MIN_CELLV_LOW_MAX, MIN_CELLV_LOW_MIN, &statusArray[51], 0, MIN_CELLV_LOW_MSG}, 
	(fault_attributes_t){false, false, PACK_OVERHEAT_ORION_PRIORITY, 0, 0, PACK_OVERHEAT_ORION_MAX, PACK_OVERHEAT_ORION_MIN, &statusArray[52], 0, PACK_OVERHEAT_ORION_MSG}, 
	(fault_attributes_t){false, false, INTERNAL_COMMS_PRIORITY, 0, 0, INTERNAL_COMMS_MAX, INTERNAL_COMMS_MIN, &statusArray[53], 0, INTERNAL_COMMS_MSG}, 
	(fault_attributes_t){false, false, CELL_BALANCING_FOFF_PRIORITY, 0, 0, CELL_BALANCING_FOFF_MAX, CELL_BALANCING_FOFF_MIN, &statusArray[54], 0, CELL_BALANCING_FOFF_MSG}, 
	(fault_attributes_t){false, false, WEAK_CELL_PRIORITY, 0, 0, WEAK_CELL_MAX, WEAK_CELL_MIN, &statusArray[55], 0, WEAK_CELL_MSG}, 
	(fault_attributes_t){false, false, LOW_CELLV_PRIORITY, 0, 0, LOW_CELLV_MAX, LOW_CELLV_MIN, &statusArray[56], 0, LOW_CELLV_MSG}, 
	(fault_attributes_t){false, false, OPEN_WIRE_PRIORITY, 0, 0, OPEN_WIRE_MAX, OPEN_WIRE_MIN, &statusArray[57], 0, OPEN_WIRE_MSG}, 
	(fault_attributes_t){false, false, CURRENT_SENSOR_PRIORITY, 0, 0, CURRENT_SENSOR_MAX, CURRENT_SENSOR_MIN, &statusArray[58], 0, CURRENT_SENSOR_MSG}, 
	(fault_attributes_t){false, false, MAX_CELLV_O5V_PRIORITY, 0, 0, MAX_CELLV_O5V_MAX, MAX_CELLV_O5V_MIN, &statusArray[59], 0, MAX_CELLV_O5V_MSG}, 
	(fault_attributes_t){false, false, CELL_ASIC_PRIORITY, 0, 0, CELL_ASIC_MAX, CELL_ASIC_MIN, &statusArray[60], 0, CELL_ASIC_MSG}, 
	(fault_attributes_t){false, false, WEAK_PACK_PRIORITY, 0, 0, WEAK_PACK_MAX, WEAK_PACK_MIN, &statusArray[61], 0, WEAK_PACK_MSG}, 
	(fault_attributes_t){false, false, FAN_MONITOR_PRIORITY, 0, 0, FAN_MONITOR_MAX, FAN_MONITOR_MIN, &statusArray[62], 0, FAN_MONITOR_MSG}, 
	(fault_attributes_t){false, false, THERMISTOR_PRIORITY, 0, 0, THERMISTOR_MAX, THERMISTOR_MIN, &statusArray[63], 0, THERMISTOR_MSG}, 
	(fault_attributes_t){false, false, EXTERNAL_COMMS_PRIORITY, 0, 0, EXTERNAL_COMMS_MAX, EXTERNAL_COMMS_MIN, &statusArray[64], 0, EXTERNAL_COMMS_MSG}, 
	(fault_attributes_t){false, false, REDUNDANT_PSU_PRIORITY, 0, 0, REDUNDANT_PSU_MAX, REDUNDANT_PSU_MIN, &statusArray[65], 0, REDUNDANT_PSU_MSG}, 
	(fault_attributes_t){false, false, HV_ISOLATION_PRIORITY, 0, 0, HV_ISOLATION_MAX, HV_ISOLATION_MIN, &statusArray[66], 0, HV_ISOLATION_MSG}, 
	(fault_attributes_t){false, false, INPUT_PSU_PRIORITY, 0, 0, INPUT_PSU_MAX, INPUT_PSU_MIN, &statusArray[67], 0, INPUT_PSU_MSG}, 
	(fault_attributes_t){false, false, CHARGE_LIMIT_ENFORCE_PRIORITY, 0, 0, CHARGE_LIMIT_ENFORCE_MAX, CHARGE_LIMIT_ENFORCE_MIN, &statusArray[68], 0, CHARGE_LIMIT_ENFORCE_MSG}, 
	(fault_attributes_t){false, false, PACK_TEMP_PRIORITY, 0, 0, PACK_TEMP_MAX, PACK_TEMP_MIN, &statusArray[69], 0, PACK_TEMP_MSG}, 
	(fault_attributes_t){false, false, PACK_TEMP_EXCEEDED_PRIORITY, 0, 0, PACK_TEMP_EXCEEDED_MAX, PACK_TEMP_EXCEEDED_MIN, &statusArray[70], 0, PACK_TEMP_EXCEEDED_MSG}, 
	...
	(fault_attributes_t){false, false, MM_DISABLED_PRIORITY, 0, 0, MM_DISABLED_MAX, MM_DISABLED_MIN, &statusArray[75], 0, MM_DISABLED_MSG}, 
	(fault_attributes_t){false, false, TV_UNCALIBRATED_PRIORITY, 0, 0, TV_UNCALIBRATED_MAX, TV_UNCALIBRATED_MIN, &statusArray[76], 0, TV_UNCALIBRATED_MSG}, 
	(fault_attributes_t){false, false, NO_GPS_FIX_PRIORITY, 0, 0, NO_GPS_FIX_MAX, NO_GPS_FIX_MIN, &statusArray[77], 0, NO_GPS_FIX_MSG}, 
	(fault_attributes_t){false, false, TV_ENABLED_PRIORITY, 0, 0, TV_ENABLED_MAX, TV_ENABLED_MIN, &statusArray[78], 0, TV_ENABLED_MSG}, 
	(fault_attributes_t){false, false, MM_ENABLED_PRIORITY, 0, 0, MM_ENABLED_MAX, MM_ENABLED_MIN, &statusArray[79], 0, MM_ENABLED_MSG}, 
	(fault_attributes_t){false, false, TV_CALIBRATED_PRIORITY, 0, 0, TV_CALIBRATED_MAX, TV_CALIBRATED_MIN, &statusArray[80], 0, TV_CALIBRATED_MSG}, 
	(fault_attributes_t){false, false, YES_GPS_FIX_PRIORITY, 0, 0, YES_GPS_FIX_MAX, YES_GPS_FIX_MIN, &statusArray[81], 0, YES_GPS_FIX_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_1_PRIORITY, 0, 0, TEST_FAULT_1_MAX, TEST_FAULT_1_MIN, &statusArray[82], 0, TEST_FAULT_1_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_2_PRIORITY, 0, 0, TEST_FAULT_2_MAX, TEST_FAULT_2_MIN, &statusArray[83], 0, TEST_FAULT_2_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_3_PRIORITY, 0, 0, TEST_FAULT_3_MAX, TEST_FAULT_3_MIN, &statusArray[84], 0, TEST_FAULT_3_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_4_PRIORITY, 0, 0, TEST_FAULT_4_MAX, TEST_FAULT_4_MIN, &statusArray[85], 0, TEST_FAULT_4_MSG}, 
};
