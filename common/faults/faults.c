...
uint16_t faultLatchTime[TOTAL_NUM_FAULTS] = {
    PDU_MCU_TEMP_HIGH_LATCH_TIME,
    DASH_RAIL_LATCH_TIME,
    ABOX_RAIL_LATCH_TIME,
    MAIN_RAIL_LATCH_TIME,
    DAQ_RAIL_LATCH_TIME,
    V_CRIT_LATCH_TIME,
    V_NONCRIT_LATCH_TIME,
    FAN1_LATCH_TIME,
    BULLET_RAIL_LATCH_TIME,
    FAN2_LATCH_TIME,
    LV_CRITICAL_LOW_LATCH_TIME,
    LV_GETTING_LOW_LATCH_TIME,
    LV_BATT_FIFTY_LATCH_TIME,
    TV_STALE_LATCH_TIME,
    RTD_EXIT_LATCH_TIME,
    LEFT_MC_CONN_LATCH_TIME,
    RIGHT_MC_CONN_LATCH_TIME,
    MCU_TEMP_HIGH_LATCH_TIME,
    DT_L_TEMP_OT_LATCH_TIME,
    DT_R_TEMP_OT_LATCH_TIME,
    DT_L_TEMP_HIGH_LATCH_TIME,
    DT_R_TEMP_HIGH_LATCH_TIME,
    BAT_COOL_LOOP_HIGH_LATCH_TIME,
    DT_COOL_LOOP_HIGH_LATCH_TIME,
    DT_R_THERM_DISC_LATCH_TIME,
    DT_L_THERM_DISC_LATCH_TIME,
    BATT_CL_DISC_LATCH_TIME,
    DT_CL_DISC_LATCH_TIME,
    BSPD_LATCHED_LATCH_TIME,
    BOTS_FAIL_LATCH_TIME,
    INERTIA_FAIL_LATCH_TIME,
    COCKPIT_ESTOP_LATCH_TIME,
    RIGHT_ESTOP_LATCH_TIME,
    LEFT_ESTOP_LATCH_TIME,
    HVD_DISC_LATCH_TIME,
    HUB_DISC_LATCH_TIME,
    TSMS_DISC_LATCH_TIME,
    PRECHARGE_TIME_FAULT_LATCH_TIME,
    MOTOR_R_HEAT_LATCH_TIME,
    MOTOR_L_HEAT_LATCH_TIME,
    MOTOR_R_OT_LATCH_TIME,
    MOTOR_L_OT_LATCH_TIME,
    APPS_WIRING_T1_LATCH_TIME,
    APPS_WIRING_T2_LATCH_TIME,
    BSE_LATCH_TIME,
    BSPD_LATCH_TIME,
    IMPLAUS_DETECTED_LATCH_TIME,
    APPS_BRAKE_LATCH_TIME,
    DISCHARGE_LIMIT_ENFORCE_LATCH_TIME,
    CHARGER_SAFETY_RELAY_LATCH_TIME,
    INTERNAL_HARDWARE_LATCH_TIME,
    HEATSINK_THERMISTOR_LATCH_TIME,
    SOFTWARE_LATCH_TIME,
    MAX_CELLV_HIGH_LATCH_TIME,
    MIN_CELLV_LOW_LATCH_TIME,
    PACK_OVERHEAT_ORION_LATCH_TIME,
    INTERNAL_COMMS_LATCH_TIME,
    CELL_BALANCING_FOFF_LATCH_TIME,
    WEAK_CELL_LATCH_TIME,
    LOW_CELLV_LATCH_TIME,
    OPEN_WIRE_LATCH_TIME,
    CURRENT_SENSOR_LATCH_TIME,
    MAX_CELLV_O5V_LATCH_TIME,
    CELL_ASIC_LATCH_TIME,
    WEAK_PACK_LATCH_TIME,
    FAN_MONITOR_LATCH_TIME,
    THERMISTOR_LATCH_TIME,
    EXTERNAL_COMMS_LATCH_TIME,
    REDUNDANT_PSU_LATCH_TIME,
    HV_ISOLATION_LATCH_TIME,
    INPUT_PSU_LATCH_TIME,
    CHARGE_LIMIT_ENFORCE_LATCH_TIME,
    PACK_TEMP_LATCH_TIME,
    PACK_TEMP_EXCEEDED_LATCH_TIME,
    MIN_PACK_TEMP_LATCH_TIME,
    IMD_LATCH_TIME,
    TMU_POWER_LOST_LATCH_TIME,
    ES_ENABLED_LATCH_TIME,
    ET_ENABLED_LATCH_TIME,
    PT_ENABLED_LATCH_TIME,
    VS_ENABLED_LATCH_TIME,
    VT_ENABLED_LATCH_TIME,
    NO_GPS_FIX_LATCH_TIME,
    YES_GPS_FIX_LATCH_TIME,
    TEST_FAULT_1_LATCH_TIME,
    TEST_FAULT_2_LATCH_TIME,
    TEST_FAULT_3_LATCH_TIME,
    TEST_FAULT_4_LATCH_TIME,
};
uint16_t faultULatchTime[TOTAL_NUM_FAULTS] = {
    PDU_MCU_TEMP_HIGH_UNLATCH_TIME,
    DASH_RAIL_UNLATCH_TIME,
    ABOX_RAIL_UNLATCH_TIME,
    MAIN_RAIL_UNLATCH_TIME,
    DAQ_RAIL_UNLATCH_TIME,
    V_CRIT_UNLATCH_TIME,
    V_NONCRIT_UNLATCH_TIME,
    FAN1_UNLATCH_TIME,
    BULLET_RAIL_UNLATCH_TIME,
    FAN2_UNLATCH_TIME,
    LV_CRITICAL_LOW_UNLATCH_TIME,
    LV_GETTING_LOW_UNLATCH_TIME,
    LV_BATT_FIFTY_UNLATCH_TIME,
    TV_STALE_UNLATCH_TIME,
    RTD_EXIT_UNLATCH_TIME,
    LEFT_MC_CONN_UNLATCH_TIME,
    RIGHT_MC_CONN_UNLATCH_TIME,
    MCU_TEMP_HIGH_UNLATCH_TIME,
    DT_L_TEMP_OT_UNLATCH_TIME,
    DT_R_TEMP_OT_UNLATCH_TIME,
    DT_L_TEMP_HIGH_UNLATCH_TIME,
    DT_R_TEMP_HIGH_UNLATCH_TIME,
    BAT_COOL_LOOP_HIGH_UNLATCH_TIME,
    DT_COOL_LOOP_HIGH_UNLATCH_TIME,
    DT_R_THERM_DISC_UNLATCH_TIME,
    DT_L_THERM_DISC_UNLATCH_TIME,
    BATT_CL_DISC_UNLATCH_TIME,
    DT_CL_DISC_UNLATCH_TIME,
    BSPD_LATCHED_UNLATCH_TIME,
    BOTS_FAIL_UNLATCH_TIME,
    INERTIA_FAIL_UNLATCH_TIME,
    COCKPIT_ESTOP_UNLATCH_TIME,
    RIGHT_ESTOP_UNLATCH_TIME,
    LEFT_ESTOP_UNLATCH_TIME,
    HVD_DISC_UNLATCH_TIME,
    HUB_DISC_UNLATCH_TIME,
    TSMS_DISC_UNLATCH_TIME,
    PRECHARGE_TIME_FAULT_UNLATCH_TIME,
    MOTOR_R_HEAT_UNLATCH_TIME,
    MOTOR_L_HEAT_UNLATCH_TIME,
    MOTOR_R_OT_UNLATCH_TIME,
    MOTOR_L_OT_UNLATCH_TIME,
    APPS_WIRING_T1_UNLATCH_TIME,
    APPS_WIRING_T2_UNLATCH_TIME,
    BSE_UNLATCH_TIME,
    BSPD_UNLATCH_TIME,
    IMPLAUS_DETECTED_UNLATCH_TIME,
    APPS_BRAKE_UNLATCH_TIME,
    DISCHARGE_LIMIT_ENFORCE_UNLATCH_TIME,
    CHARGER_SAFETY_RELAY_UNLATCH_TIME,
    INTERNAL_HARDWARE_UNLATCH_TIME,
    HEATSINK_THERMISTOR_UNLATCH_TIME,
    SOFTWARE_UNLATCH_TIME,
    MAX_CELLV_HIGH_UNLATCH_TIME,
    MIN_CELLV_LOW_UNLATCH_TIME,
    PACK_OVERHEAT_ORION_UNLATCH_TIME,
    INTERNAL_COMMS_UNLATCH_TIME,
    CELL_BALANCING_FOFF_UNLATCH_TIME,
    WEAK_CELL_UNLATCH_TIME,
    LOW_CELLV_UNLATCH_TIME,
    OPEN_WIRE_UNLATCH_TIME,
    CURRENT_SENSOR_UNLATCH_TIME,
    MAX_CELLV_O5V_UNLATCH_TIME,
    CELL_ASIC_UNLATCH_TIME,
    WEAK_PACK_UNLATCH_TIME,
    FAN_MONITOR_UNLATCH_TIME,
    THERMISTOR_UNLATCH_TIME,
    EXTERNAL_COMMS_UNLATCH_TIME,
    REDUNDANT_PSU_UNLATCH_TIME,
    HV_ISOLATION_UNLATCH_TIME,
    INPUT_PSU_UNLATCH_TIME,
    CHARGE_LIMIT_ENFORCE_UNLATCH_TIME,
    PACK_TEMP_UNLATCH_TIME,
    PACK_TEMP_EXCEEDED_UNLATCH_TIME,
    MIN_PACK_TEMP_UNLATCH_TIME,
    IMD_UNLATCH_TIME,
    TMU_POWER_LOST_UNLATCH_TIME,
    ES_ENABLED_UNLATCH_TIME,
    ET_ENABLED_UNLATCH_TIME,
    PT_ENABLED_UNLATCH_TIME,
    VS_ENABLED_UNLATCH_TIME,
    VT_ENABLED_UNLATCH_TIME,
    NO_GPS_FIX_UNLATCH_TIME,
    YES_GPS_FIX_UNLATCH_TIME,
    TEST_FAULT_1_UNLATCH_TIME,
    TEST_FAULT_2_UNLATCH_TIME,
    TEST_FAULT_3_UNLATCH_TIME,
...
fault_status_t statusArray[TOTAL_NUM_FAULTS] = {
    ...
    (fault_status_t) {false, ID_TV_STALE_FAULT},
...
fault_attributes_t faultArray[TOTAL_NUM_FAULTS] = {
    (fault_attributes_t) {false,
                          false,
                          PDU_MCU_TEMP_HIGH_PRIORITY,
                          0,
                          0,
                          PDU_MCU_TEMP_HIGH_MAX,
                          PDU_MCU_TEMP_HIGH_MIN,
                          &statusArray[0],
                          0,
                          PDU_MCU_TEMP_HIGH_MSG},
    (fault_attributes_t) {false,
                          false,
                          DASH_RAIL_PRIORITY,
                          0,
    ...
    (fault_attributes_t) {false,
                          false,
                          BAT_COOL_LOOP_HIGH_PRIORITY,
                          0,
                          0,
                          BAT_COOL_LOOP_HIGH_MAX,
                          BAT_COOL_LOOP_HIGH_MIN,
                          &statusArray[22],
                          0,
                          BAT_COOL_LOOP_HIGH_MSG},
    (fault_attributes_t) {false,
                          false,
                          DT_COOL_LOOP_HIGH_PRIORITY,
                          0,
                          0,
                          DT_COOL_LOOP_HIGH_MAX,
                          DT_COOL_LOOP_HIGH_MIN,
                          &statusArray[23],
                          0,
                          DT_COOL_LOOP_HIGH_MSG},
    (fault_attributes_t) {false,
                          false,
                          DT_R_THERM_DISC_PRIORITY,
                          0,
                          0,
                          DT_R_THERM_DISC_MAX,
                          DT_R_THERM_DISC_MIN,
    ...
    (fault_attributes_t) {false,
                          false,
                          PRECHARGE_TIME_FAULT_PRIORITY,
                          0,
                          0,
                          PRECHARGE_TIME_FAULT_MAX,
                          PRECHARGE_TIME_FAULT_MIN,
                          &statusArray[37],
                          0,
                          PRECHARGE_TIME_FAULT_MSG},
    (fault_attributes_t) {false,
                          false,
                          MOTOR_R_HEAT_PRIORITY,
                          0,
                          0,
                          MOTOR_R_HEAT_MAX,
                          MOTOR_R_HEAT_MIN,
    ...
    (fault_attributes_t) {false,
                          false,
                          IMPLAUS_DETECTED_PRIORITY,
                          0,
                          0,
                          IMPLAUS_DETECTED_MAX,
                          IMPLAUS_DETECTED_MIN,
                          &statusArray[46],
                          0,
                          IMPLAUS_DETECTED_MSG},
    (fault_attributes_t) {false,
                          false,
                          APPS_BRAKE_PRIORITY,
                          0,
    ...
    (fault_attributes_t) {false,
                          false,
                          DISCHARGE_LIMIT_ENFORCE_PRIORITY,
                          0,
                          0,
                          DISCHARGE_LIMIT_ENFORCE_MAX,
                          DISCHARGE_LIMIT_ENFORCE_MIN,
                          &statusArray[48],
                          0,
                          DISCHARGE_LIMIT_ENFORCE_MSG},
    (fault_attributes_t) {false,
                          false,
                          CHARGER_SAFETY_RELAY_PRIORITY,
                          0,
                          0,
                          CHARGER_SAFETY_RELAY_MAX,
                          CHARGER_SAFETY_RELAY_MIN,
                          &statusArray[49],
                          0,
                          CHARGER_SAFETY_RELAY_MSG},
    (fault_attributes_t) {false,
                          false,
                          INTERNAL_HARDWARE_PRIORITY,
                          0,
                          0,
                          INTERNAL_HARDWARE_MAX,
                          INTERNAL_HARDWARE_MIN,
                          &statusArray[50],
                          0,
                          INTERNAL_HARDWARE_MSG},
    (fault_attributes_t) {false,
                          false,
                          HEATSINK_THERMISTOR_PRIORITY,
                          0,
                          0,
                          HEATSINK_THERMISTOR_MAX,
                          HEATSINK_THERMISTOR_MIN,
                          &statusArray[51],
                          0,
                          HEATSINK_THERMISTOR_MSG},
    (fault_attributes_t) {false,
                          false,
                          SOFTWARE_PRIORITY,
                          0,
    ...
    (fault_attributes_t) {false,
                          false,
                          PACK_OVERHEAT_ORION_PRIORITY,
                          0,
                          0,
                          PACK_OVERHEAT_ORION_MAX,
                          PACK_OVERHEAT_ORION_MIN,
                          &statusArray[55],
                          0,
                          PACK_OVERHEAT_ORION_MSG},
    (fault_attributes_t) {false,
                          false,
                          INTERNAL_COMMS_PRIORITY,
                          0,
                          0,
                          INTERNAL_COMMS_MAX,
                          INTERNAL_COMMS_MIN,
    ...
    (fault_attributes_t) {false,
                          false,
                          CELL_BALANCING_FOFF_PRIORITY,
                          0,
                          0,
                          CELL_BALANCING_FOFF_MAX,
                          CELL_BALANCING_FOFF_MIN,
                          &statusArray[57],
                          0,
                          CELL_BALANCING_FOFF_MSG},
    (fault_attributes_t) {false,
                          false,
                          WEAK_CELL_PRIORITY,
                          0,
    ...
    (fault_attributes_t) {false,
                          false,
                          CHARGE_LIMIT_ENFORCE_PRIORITY,
                          0,
                          0,
                          CHARGE_LIMIT_ENFORCE_MAX,
                          CHARGE_LIMIT_ENFORCE_MIN,
                          &statusArray[71],
                          0,
    ...
    (fault_attributes_t) {false,
                          false,
                          PACK_TEMP_EXCEEDED_PRIORITY,
                          0,
                          0,
                          PACK_TEMP_EXCEEDED_MAX,
                          PACK_TEMP_EXCEEDED_MIN,
                          &statusArray[73],
                          0,
                          PACK_TEMP_EXCEEDED_MSG},
    (fault_attributes_t) {false,
                          false,
                          MIN_PACK_TEMP_PRIORITY,
                          0,
                          0,
                          MIN_PACK_TEMP_MAX,
                          MIN_PACK_TEMP_MIN,
