...
<<<<<<< HEAD
			TMU_POWER_LOST_LATCH_TIME, ES_ENABLED_LATCH_TIME, ET_ENABLED_LATCH_TIME, PT_ENABLED_LATCH_TIME, VS_ENABLED_LATCH_TIME, VT_ENABLED_LATCH_TIME, NO_GPS_FIX_LATCH_TIME,
			YES_GPS_FIX_LATCH_TIME, TEST_FAULT_1_LATCH_TIME, TEST_FAULT_2_LATCH_TIME, TEST_FAULT_3_LATCH_TIME, TEST_FAULT_4_LATCH_TIME,};
=======
			DASH_ADC_THRTL_LATCH_TIME, DISCHARGE_LIMIT_ENFORCE_LATCH_TIME, CHARGER_SAFETY_RELAY_LATCH_TIME, INTERNAL_HARDWARE_LATCH_TIME, HEATSINK_THERMISTOR_LATCH_TIME, SOFTWARE_LATCH_TIME, MAX_CELLV_HIGH_LATCH_TIME,
			...
			IMD_LATCH_TIME, TMU_POWER_LOST_LATCH_TIME, TV_DISABLED_LATCH_TIME, MM_DISABLED_LATCH_TIME, TV_UNCALIBRATED_LATCH_TIME, NO_GPS_FIX_LATCH_TIME, TV_ENABLED_LATCH_TIME,
			MM_ENABLED_LATCH_TIME, TV_CALIBRATED_LATCH_TIME, YES_GPS_FIX_LATCH_TIME, TEST_FAULT_1_LATCH_TIME, TEST_FAULT_2_LATCH_TIME, TEST_FAULT_3_LATCH_TIME, TEST_FAULT_4_LATCH_TIME,
};
>>>>>>> 1af2f030 (set fault)
=======
			TMU_POWER_LOST_LATCH_TIME, TV_DISABLED_LATCH_TIME, MM_DISABLED_LATCH_TIME, TV_UNCALIBRATED_LATCH_TIME, NO_GPS_FIX_LATCH_TIME, TV_ENABLED_LATCH_TIME, MM_ENABLED_LATCH_TIME,
			TV_CALIBRATED_LATCH_TIME, YES_GPS_FIX_LATCH_TIME, TEST_FAULT_1_LATCH_TIME, TEST_FAULT_2_LATCH_TIME, TEST_FAULT_3_LATCH_TIME, TEST_FAULT_4_LATCH_TIME,};
>>>>>>> 08e71cea (Bugs)
...
<<<<<<< HEAD
			TMU_POWER_LOST_UNLATCH_TIME, ES_ENABLED_UNLATCH_TIME, ET_ENABLED_UNLATCH_TIME, PT_ENABLED_UNLATCH_TIME, VS_ENABLED_UNLATCH_TIME, VT_ENABLED_UNLATCH_TIME, NO_GPS_FIX_UNLATCH_TIME,
			YES_GPS_FIX_UNLATCH_TIME, TEST_FAULT_1_UNLATCH_TIME, TEST_FAULT_2_UNLATCH_TIME, TEST_FAULT_3_UNLATCH_TIME, TEST_FAULT_4_UNLATCH_TIME,};
=======
			DASH_ADC_THRTL_UNLATCH_TIME, DISCHARGE_LIMIT_ENFORCE_UNLATCH_TIME, CHARGER_SAFETY_RELAY_UNLATCH_TIME, INTERNAL_HARDWARE_UNLATCH_TIME, HEATSINK_THERMISTOR_UNLATCH_TIME, SOFTWARE_UNLATCH_TIME, MAX_CELLV_HIGH_UNLATCH_TIME,
			...
			IMD_UNLATCH_TIME, TMU_POWER_LOST_UNLATCH_TIME, TV_DISABLED_UNLATCH_TIME, MM_DISABLED_UNLATCH_TIME, TV_UNCALIBRATED_UNLATCH_TIME, NO_GPS_FIX_UNLATCH_TIME, TV_ENABLED_UNLATCH_TIME,
			MM_ENABLED_UNLATCH_TIME, TV_CALIBRATED_UNLATCH_TIME, YES_GPS_FIX_UNLATCH_TIME, TEST_FAULT_1_UNLATCH_TIME, TEST_FAULT_2_UNLATCH_TIME, TEST_FAULT_3_UNLATCH_TIME, TEST_FAULT_4_UNLATCH_TIME,
};
>>>>>>> 1af2f030 (set fault)
=======
			TMU_POWER_LOST_UNLATCH_TIME, TV_DISABLED_UNLATCH_TIME, MM_DISABLED_UNLATCH_TIME, TV_UNCALIBRATED_UNLATCH_TIME, NO_GPS_FIX_UNLATCH_TIME, TV_ENABLED_UNLATCH_TIME, MM_ENABLED_UNLATCH_TIME,
			TV_CALIBRATED_UNLATCH_TIME, YES_GPS_FIX_UNLATCH_TIME, TEST_FAULT_1_UNLATCH_TIME, TEST_FAULT_2_UNLATCH_TIME, TEST_FAULT_3_UNLATCH_TIME, TEST_FAULT_4_UNLATCH_TIME,};
>>>>>>> 08e71cea (Bugs)
...
fault_status_t statusArray[TOTAL_NUM_FAULTS] = {
	...
	(fault_status_t){false, ID_ES_ENABLED_FAULT},
...
<<<<<<< HEAD
	(fault_attributes_t){false, false, ES_ENABLED_PRIORITY, 0, 0, ES_ENABLED_MAX, ES_ENABLED_MIN, &statusArray[77], 0, ES_ENABLED_MSG}, 
	(fault_attributes_t){false, false, ET_ENABLED_PRIORITY, 0, 0, ET_ENABLED_MAX, ET_ENABLED_MIN, &statusArray[78], 0, ET_ENABLED_MSG}, 
	(fault_attributes_t){false, false, PT_ENABLED_PRIORITY, 0, 0, PT_ENABLED_MAX, PT_ENABLED_MIN, &statusArray[79], 0, PT_ENABLED_MSG}, 
	(fault_attributes_t){false, false, VS_ENABLED_PRIORITY, 0, 0, VS_ENABLED_MAX, VS_ENABLED_MIN, &statusArray[80], 0, VS_ENABLED_MSG}, 
	(fault_attributes_t){false, false, VT_ENABLED_PRIORITY, 0, 0, VT_ENABLED_MAX, VT_ENABLED_MIN, &statusArray[81], 0, VT_ENABLED_MSG}, 
	(fault_attributes_t){false, false, NO_GPS_FIX_PRIORITY, 0, 0, NO_GPS_FIX_MAX, NO_GPS_FIX_MIN, &statusArray[82], 0, NO_GPS_FIX_MSG}, 
	(fault_attributes_t){false, false, YES_GPS_FIX_PRIORITY, 0, 0, YES_GPS_FIX_MAX, YES_GPS_FIX_MIN, &statusArray[83], 0, YES_GPS_FIX_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_1_PRIORITY, 0, 0, TEST_FAULT_1_MAX, TEST_FAULT_1_MIN, &statusArray[84], 0, TEST_FAULT_1_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_2_PRIORITY, 0, 0, TEST_FAULT_2_MAX, TEST_FAULT_2_MIN, &statusArray[85], 0, TEST_FAULT_2_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_3_PRIORITY, 0, 0, TEST_FAULT_3_MAX, TEST_FAULT_3_MIN, &statusArray[86], 0, TEST_FAULT_3_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_4_PRIORITY, 0, 0, TEST_FAULT_4_MAX, TEST_FAULT_4_MIN, &statusArray[87], 0, TEST_FAULT_4_MSG}, 
=======
	(fault_attributes_t){false, false, DASH_ADC_THRTL_PRIORITY, 0, 0, DASH_ADC_THRTL_MAX, DASH_ADC_THRTL_MIN, &statusArray[48], 0, DASH_ADC_THRTL_MSG}, 
	(fault_attributes_t){false, false, DISCHARGE_LIMIT_ENFORCE_PRIORITY, 0, 0, DISCHARGE_LIMIT_ENFORCE_MAX, DISCHARGE_LIMIT_ENFORCE_MIN, &statusArray[49], 0, DISCHARGE_LIMIT_ENFORCE_MSG}, 
	(fault_attributes_t){false, false, CHARGER_SAFETY_RELAY_PRIORITY, 0, 0, CHARGER_SAFETY_RELAY_MAX, CHARGER_SAFETY_RELAY_MIN, &statusArray[50], 0, CHARGER_SAFETY_RELAY_MSG}, 
	(fault_attributes_t){false, false, INTERNAL_HARDWARE_PRIORITY, 0, 0, INTERNAL_HARDWARE_MAX, INTERNAL_HARDWARE_MIN, &statusArray[51], 0, INTERNAL_HARDWARE_MSG}, 
	(fault_attributes_t){false, false, HEATSINK_THERMISTOR_PRIORITY, 0, 0, HEATSINK_THERMISTOR_MAX, HEATSINK_THERMISTOR_MIN, &statusArray[52], 0, HEATSINK_THERMISTOR_MSG}, 
	(fault_attributes_t){false, false, SOFTWARE_PRIORITY, 0, 0, SOFTWARE_MAX, SOFTWARE_MIN, &statusArray[53], 0, SOFTWARE_MSG}, 
	(fault_attributes_t){false, false, MAX_CELLV_HIGH_PRIORITY, 0, 0, MAX_CELLV_HIGH_MAX, MAX_CELLV_HIGH_MIN, &statusArray[54], 0, MAX_CELLV_HIGH_MSG}, 
	(fault_attributes_t){false, false, MIN_CELLV_LOW_PRIORITY, 0, 0, MIN_CELLV_LOW_MAX, MIN_CELLV_LOW_MIN, &statusArray[55], 0, MIN_CELLV_LOW_MSG}, 
	(fault_attributes_t){false, false, PACK_OVERHEAT_ORION_PRIORITY, 0, 0, PACK_OVERHEAT_ORION_MAX, PACK_OVERHEAT_ORION_MIN, &statusArray[56], 0, PACK_OVERHEAT_ORION_MSG}, 
	(fault_attributes_t){false, false, INTERNAL_COMMS_PRIORITY, 0, 0, INTERNAL_COMMS_MAX, INTERNAL_COMMS_MIN, &statusArray[57], 0, INTERNAL_COMMS_MSG}, 
	(fault_attributes_t){false, false, CELL_BALANCING_FOFF_PRIORITY, 0, 0, CELL_BALANCING_FOFF_MAX, CELL_BALANCING_FOFF_MIN, &statusArray[58], 0, CELL_BALANCING_FOFF_MSG}, 
	(fault_attributes_t){false, false, WEAK_CELL_PRIORITY, 0, 0, WEAK_CELL_MAX, WEAK_CELL_MIN, &statusArray[59], 0, WEAK_CELL_MSG}, 
	(fault_attributes_t){false, false, LOW_CELLV_PRIORITY, 0, 0, LOW_CELLV_MAX, LOW_CELLV_MIN, &statusArray[60], 0, LOW_CELLV_MSG}, 
	(fault_attributes_t){false, false, OPEN_WIRE_PRIORITY, 0, 0, OPEN_WIRE_MAX, OPEN_WIRE_MIN, &statusArray[61], 0, OPEN_WIRE_MSG}, 
	(fault_attributes_t){false, false, CURRENT_SENSOR_PRIORITY, 0, 0, CURRENT_SENSOR_MAX, CURRENT_SENSOR_MIN, &statusArray[62], 0, CURRENT_SENSOR_MSG}, 
	(fault_attributes_t){false, false, MAX_CELLV_O5V_PRIORITY, 0, 0, MAX_CELLV_O5V_MAX, MAX_CELLV_O5V_MIN, &statusArray[63], 0, MAX_CELLV_O5V_MSG}, 
	(fault_attributes_t){false, false, CELL_ASIC_PRIORITY, 0, 0, CELL_ASIC_MAX, CELL_ASIC_MIN, &statusArray[64], 0, CELL_ASIC_MSG}, 
	(fault_attributes_t){false, false, WEAK_PACK_PRIORITY, 0, 0, WEAK_PACK_MAX, WEAK_PACK_MIN, &statusArray[65], 0, WEAK_PACK_MSG}, 
	(fault_attributes_t){false, false, FAN_MONITOR_PRIORITY, 0, 0, FAN_MONITOR_MAX, FAN_MONITOR_MIN, &statusArray[66], 0, FAN_MONITOR_MSG}, 
	(fault_attributes_t){false, false, THERMISTOR_PRIORITY, 0, 0, THERMISTOR_MAX, THERMISTOR_MIN, &statusArray[67], 0, THERMISTOR_MSG}, 
	(fault_attributes_t){false, false, EXTERNAL_COMMS_PRIORITY, 0, 0, EXTERNAL_COMMS_MAX, EXTERNAL_COMMS_MIN, &statusArray[68], 0, EXTERNAL_COMMS_MSG}, 
	(fault_attributes_t){false, false, REDUNDANT_PSU_PRIORITY, 0, 0, REDUNDANT_PSU_MAX, REDUNDANT_PSU_MIN, &statusArray[69], 0, REDUNDANT_PSU_MSG}, 
	(fault_attributes_t){false, false, HV_ISOLATION_PRIORITY, 0, 0, HV_ISOLATION_MAX, HV_ISOLATION_MIN, &statusArray[70], 0, HV_ISOLATION_MSG}, 
	(fault_attributes_t){false, false, INPUT_PSU_PRIORITY, 0, 0, INPUT_PSU_MAX, INPUT_PSU_MIN, &statusArray[71], 0, INPUT_PSU_MSG}, 
	(fault_attributes_t){false, false, CHARGE_LIMIT_ENFORCE_PRIORITY, 0, 0, CHARGE_LIMIT_ENFORCE_MAX, CHARGE_LIMIT_ENFORCE_MIN, &statusArray[72], 0, CHARGE_LIMIT_ENFORCE_MSG}, 
	(fault_attributes_t){false, false, PACK_TEMP_PRIORITY, 0, 0, PACK_TEMP_MAX, PACK_TEMP_MIN, &statusArray[73], 0, PACK_TEMP_MSG}, 
	(fault_attributes_t){false, false, PACK_TEMP_EXCEEDED_PRIORITY, 0, 0, PACK_TEMP_EXCEEDED_MAX, PACK_TEMP_EXCEEDED_MIN, &statusArray[74], 0, PACK_TEMP_EXCEEDED_MSG}, 
	(fault_attributes_t){false, false, MIN_PACK_TEMP_PRIORITY, 0, 0, MIN_PACK_TEMP_MAX, MIN_PACK_TEMP_MIN, &statusArray[75], 0, MIN_PACK_TEMP_MSG}, 
	(fault_attributes_t){false, false, IMD_PRIORITY, 0, 0, IMD_MAX, IMD_MIN, &statusArray[76], 0, IMD_MSG}, 
	(fault_attributes_t){false, false, TMU_POWER_LOST_PRIORITY, 0, 0, TMU_POWER_LOST_MAX, TMU_POWER_LOST_MIN, &statusArray[77], 0, TMU_POWER_LOST_MSG}, 
	(fault_attributes_t){false, false, TV_DISABLED_PRIORITY, 0, 0, TV_DISABLED_MAX, TV_DISABLED_MIN, &statusArray[78], 0, TV_DISABLED_MSG}, 
	(fault_attributes_t){false, false, MM_DISABLED_PRIORITY, 0, 0, MM_DISABLED_MAX, MM_DISABLED_MIN, &statusArray[79], 0, MM_DISABLED_MSG}, 
	(fault_attributes_t){false, false, TV_UNCALIBRATED_PRIORITY, 0, 0, TV_UNCALIBRATED_MAX, TV_UNCALIBRATED_MIN, &statusArray[80], 0, TV_UNCALIBRATED_MSG}, 
	(fault_attributes_t){false, false, NO_GPS_FIX_PRIORITY, 0, 0, NO_GPS_FIX_MAX, NO_GPS_FIX_MIN, &statusArray[81], 0, NO_GPS_FIX_MSG}, 
	(fault_attributes_t){false, false, TV_ENABLED_PRIORITY, 0, 0, TV_ENABLED_MAX, TV_ENABLED_MIN, &statusArray[82], 0, TV_ENABLED_MSG}, 
	(fault_attributes_t){false, false, MM_ENABLED_PRIORITY, 0, 0, MM_ENABLED_MAX, MM_ENABLED_MIN, &statusArray[83], 0, MM_ENABLED_MSG}, 
	(fault_attributes_t){false, false, TV_CALIBRATED_PRIORITY, 0, 0, TV_CALIBRATED_MAX, TV_CALIBRATED_MIN, &statusArray[84], 0, TV_CALIBRATED_MSG}, 
	(fault_attributes_t){false, false, YES_GPS_FIX_PRIORITY, 0, 0, YES_GPS_FIX_MAX, YES_GPS_FIX_MIN, &statusArray[85], 0, YES_GPS_FIX_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_1_PRIORITY, 0, 0, TEST_FAULT_1_MAX, TEST_FAULT_1_MIN, &statusArray[86], 0, TEST_FAULT_1_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_2_PRIORITY, 0, 0, TEST_FAULT_2_MAX, TEST_FAULT_2_MIN, &statusArray[87], 0, TEST_FAULT_2_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_3_PRIORITY, 0, 0, TEST_FAULT_3_MAX, TEST_FAULT_3_MIN, &statusArray[88], 0, TEST_FAULT_3_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_4_PRIORITY, 0, 0, TEST_FAULT_4_MAX, TEST_FAULT_4_MIN, &statusArray[89], 0, TEST_FAULT_4_MSG}, 
>>>>>>> 1af2f030 (set fault)
=======
	(fault_attributes_t){false, false, TV_DISABLED_PRIORITY, 0, 0, TV_DISABLED_MAX, TV_DISABLED_MIN, &statusArray[77], 0, TV_DISABLED_MSG}, 
	(fault_attributes_t){false, false, MM_DISABLED_PRIORITY, 0, 0, MM_DISABLED_MAX, MM_DISABLED_MIN, &statusArray[78], 0, MM_DISABLED_MSG}, 
	(fault_attributes_t){false, false, TV_UNCALIBRATED_PRIORITY, 0, 0, TV_UNCALIBRATED_MAX, TV_UNCALIBRATED_MIN, &statusArray[79], 0, TV_UNCALIBRATED_MSG}, 
	(fault_attributes_t){false, false, NO_GPS_FIX_PRIORITY, 0, 0, NO_GPS_FIX_MAX, NO_GPS_FIX_MIN, &statusArray[80], 0, NO_GPS_FIX_MSG}, 
	(fault_attributes_t){false, false, TV_ENABLED_PRIORITY, 0, 0, TV_ENABLED_MAX, TV_ENABLED_MIN, &statusArray[81], 0, TV_ENABLED_MSG}, 
	(fault_attributes_t){false, false, MM_ENABLED_PRIORITY, 0, 0, MM_ENABLED_MAX, MM_ENABLED_MIN, &statusArray[82], 0, MM_ENABLED_MSG}, 
	(fault_attributes_t){false, false, TV_CALIBRATED_PRIORITY, 0, 0, TV_CALIBRATED_MAX, TV_CALIBRATED_MIN, &statusArray[83], 0, TV_CALIBRATED_MSG}, 
	(fault_attributes_t){false, false, YES_GPS_FIX_PRIORITY, 0, 0, YES_GPS_FIX_MAX, YES_GPS_FIX_MIN, &statusArray[84], 0, YES_GPS_FIX_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_1_PRIORITY, 0, 0, TEST_FAULT_1_MAX, TEST_FAULT_1_MIN, &statusArray[85], 0, TEST_FAULT_1_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_2_PRIORITY, 0, 0, TEST_FAULT_2_MAX, TEST_FAULT_2_MIN, &statusArray[86], 0, TEST_FAULT_2_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_3_PRIORITY, 0, 0, TEST_FAULT_3_MAX, TEST_FAULT_3_MIN, &statusArray[87], 0, TEST_FAULT_3_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_4_PRIORITY, 0, 0, TEST_FAULT_4_MAX, TEST_FAULT_4_MIN, &statusArray[88], 0, TEST_FAULT_4_MSG}, 
>>>>>>> 08e71cea (Bugs)
};
