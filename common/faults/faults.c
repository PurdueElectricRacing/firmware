...
uint16_t faultLatchTime[TOTAL_NUM_FAULTS] = { PDU_MCU_TEMP_HIGH_LATCH_TIME, DASH_RAIL_LATCH_TIME, ABOX_RAIL_LATCH_TIME, MAIN_RAIL_LATCH_TIME, DAQ_RAIL_LATCH_TIME, V_CRIT_LATCH_TIME,
			...
			NO_GPS_FIX_LATCH_TIME, TV_ENABLED_LATCH_TIME, TV_CALIBRATED_LATCH_TIME, YES_GPS_FIX_LATCH_TIME, TEST_FAULT_1_LATCH_TIME, TEST_FAULT_2_LATCH_TIME, TEST_FAULT_3_LATCH_TIME,
...
uint16_t faultULatchTime[TOTAL_NUM_FAULTS] = { PDU_MCU_TEMP_HIGH_UNLATCH_TIME, DASH_RAIL_UNLATCH_TIME, ABOX_RAIL_UNLATCH_TIME, MAIN_RAIL_UNLATCH_TIME, DAQ_RAIL_UNLATCH_TIME, V_CRIT_UNLATCH_TIME,
			...
			NO_GPS_FIX_UNLATCH_TIME, TV_ENABLED_UNLATCH_TIME, TV_CALIBRATED_UNLATCH_TIME, YES_GPS_FIX_UNLATCH_TIME, TEST_FAULT_1_UNLATCH_TIME, TEST_FAULT_2_UNLATCH_TIME, TEST_FAULT_3_UNLATCH_TIME,
...
fault_attributes_t faultArray[TOTAL_NUM_FAULTS] = {
	...
	(fault_attributes_t){false, false, TV_ENABLED_PRIORITY, 0, 0, TV_ENABLED_MAX, TV_ENABLED_MIN, &statusArray[77], 0, TV_ENABLED_MSG}, 
	(fault_attributes_t){false, false, TV_CALIBRATED_PRIORITY, 0, 0, TV_CALIBRATED_MAX, TV_CALIBRATED_MIN, &statusArray[78], 0, TV_CALIBRATED_MSG}, 
	(fault_attributes_t){false, false, YES_GPS_FIX_PRIORITY, 0, 0, YES_GPS_FIX_MAX, YES_GPS_FIX_MIN, &statusArray[79], 0, YES_GPS_FIX_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_1_PRIORITY, 0, 0, TEST_FAULT_1_MAX, TEST_FAULT_1_MIN, &statusArray[80], 0, TEST_FAULT_1_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_2_PRIORITY, 0, 0, TEST_FAULT_2_MAX, TEST_FAULT_2_MIN, &statusArray[81], 0, TEST_FAULT_2_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_3_PRIORITY, 0, 0, TEST_FAULT_3_MAX, TEST_FAULT_3_MIN, &statusArray[82], 0, TEST_FAULT_3_MSG}, 
	(fault_attributes_t){false, false, TEST_FAULT_4_PRIORITY, 0, 0, TEST_FAULT_4_MAX, TEST_FAULT_4_MIN, &statusArray[83], 0, TEST_FAULT_4_MSG}, 
};
