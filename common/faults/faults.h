...
#define TOTAL_MAIN_MODULE_FAULTS 11
...
#define ID_MAIN_COMM_FAULT 0x9
#define ID_LV_DEAD_FAULT 0xa
#define ID_MOT_FRONT_OT_FAULT 0x100b
#define ID_WLSPD_L_FAULT 0x100c
#define ID_WLSPD_R_FAULT 0x100d
#define ID_DRIVELINE_COMM_FAULT 0x100e
#define ID_APPS_WIRING_T1_FAULT 0x200f
#define ID_APPS_WIRING_T2_FAULT 0x2010
#define ID_BSE_FAULT 0x2011
#define ID_BSPD_FAULT 0x2012
#define ID_IMPLAUS_DETECTED_FAULT 0x2013
#define ID_APPS_BRAKE_FAULT 0x2014
#define ID_DISCHARGE_LIMIT_ENFORCE_FAULT 0x3015
#define ID_CHARGER_SAFETY_RELAY_FAULT 0x3016
#define ID_INTERNAL_HARDWARE_FAULT 0x3017
#define ID_HEATSINK_THERMISTOR_FAULT 0x3018
#define ID_SOFTWARE_FAULT 0x3019
#define ID_MAX_CELLV_HIGH_FAULT 0x301a
#define ID_MIN_CELLV_LOW_FAULT 0x301b
#define ID_PACK_OVERHEAT_ORION_FAULT 0x301c
#define ID_INTERNAL_COMMS_FAULT 0x301d
#define ID_CELL_BALANCING_FOFF_FAULT 0x301e
#define ID_WEAK_CELL_FAULT 0x301f
#define ID_LOW_CELLV_FAULT 0x3020
#define ID_OPEN_WIRE_FAULT 0x3021
#define ID_CURRENT_SENSOR_FAULT 0x3022
#define ID_MAX_CELLV_O5V_FAULT 0x3023
#define ID_CELL_ASIC_FAULT 0x3024
#define ID_WEAK_PACK_FAULT 0x3025
#define ID_FAN_MONITOR_FAULT 0x3026
#define ID_THERMISTOR_FAULT 0x3027
#define ID_EXTERNAL_COMMS_FAULT 0x3028
#define ID_REDUNDANT_PSU_FAULT 0x3029
#define ID_HV_ISOLATION_FAULT 0x302a
#define ID_INPUT_PSU_FAULT 0x302b
#define ID_CHARGE_LIMIT_ENFORCE_FAULT 0x302c
#define ID_PACK_TEMP_FAULT 0x302d
#define ID_PACK_TEMP_EXCEEDED_FAULT 0x302e
#define ID_MIN_PACK_TEMP_FAULT 0x302f
#define ID_IMD_FAULT 0x3030
#define ID_TV_OFFLINE_FAULT 0x4031
#define ID_TEST_FAULT_1_FAULT 0x5032
#define ID_TEST_FAULT_2_FAULT 0x5033
#define ID_TEST_FAULT_3_FAULT 0x5034
#define ID_TEST_FAULT_4_FAULT 0x5035
//END AUTO ID DEFS
