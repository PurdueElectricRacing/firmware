...
#define TOTAL_NUM_FAULTS 59
//END AUTO TOTAL DEFS

//BEGIN AUTO ID DEFS
#define ID_PDU_MCU_TEMP_HIGH_FAULT 0x0
#define ID_PDU_PUMP_1_AUTO_SWITCH_FAULT 0x1
#define ID_PDU_PUMP_2_AUTO_SWITCH_FAULT 0x2
#define ID_PDU_SDC_AUTO_SWITCH_FAULT 0x3
#define ID_PDU_AUX_AUTO_SWITCH_FAULT 0x4
#define ID_PDU_FAN_1_AUTO_SWITCH_FAULT 0x5
#define ID_PDU_FAN_2_AUTO_SWITCH_FAULT 0x6
#define ID_PDU_BLT_AUTO_SWITCH_FAULT 0x7
#define ID_PDU_CRIT_5V_AUTO_SWITCH_FAULT 0x8
#define ID_PDU_NCRIT_5V_AUTO_SWITCH_FAULT 0x9
#define ID_PDU_DAQ_AUTO_SWITCH_FAULT 0xa
#define ID_PDU_FAN_5V_AUTO_SWITCH_FAULT 0xb
#define ID_PCHG_IMPLAUS_FAULT 0x100c
#define ID_RTD_EXIT_FAULT 0x100d
#define ID_LEFT_MC_CONN_FAULT 0x100e
#define ID_RIGHT_MC_CONN_FAULT 0x100f
#define ID_MCU_TEMP_HIGH_FAULT 0x1010
#define ID_LV_BAT_LOW_FAULT 0x1011
#define ID_LV_BAT_VERY_LOW_FAULT 0x1012
#define ID_LV_BAT_BMS_FAULT 0x1013
#define ID_DRIVE_FLOW_FAULT 0x1014
#define ID_APPS_WIRING_T1_FAULT 0x2015
#define ID_APPS_WIRING_T2_FAULT 0x2016
#define ID_BSE_FAULT 0x2017
#define ID_BSPD_FAULT 0x2018
#define ID_IMPLAUS_DETECTED_FAULT 0x2019
#define ID_APPS_BRAKE_FAULT 0x201a
#define ID_DISCHARGE_LIMIT_ENFORCE_FAULT 0x301b
#define ID_CHARGER_SAFETY_RELAY_FAULT 0x301c
#define ID_INTERNAL_HARDWARE_FAULT 0x301d
#define ID_HEATSINK_THERMISTOR_FAULT 0x301e
#define ID_SOFTWARE_FAULT 0x301f
#define ID_MAX_CELLV_HIGH_FAULT 0x3020
#define ID_MIN_CELLV_LOW_FAULT 0x3021
#define ID_PACK_OVERHEAT_ORION_FAULT 0x3022
#define ID_INTERNAL_COMMS_FAULT 0x3023
#define ID_CELL_BALANCING_FOFF_FAULT 0x3024
#define ID_WEAK_CELL_FAULT 0x3025
#define ID_LOW_CELLV_FAULT 0x3026
#define ID_OPEN_WIRE_FAULT 0x3027
#define ID_CURRENT_SENSOR_FAULT 0x3028
#define ID_MAX_CELLV_O5V_FAULT 0x3029
#define ID_CELL_ASIC_FAULT 0x302a
#define ID_WEAK_PACK_FAULT 0x302b
#define ID_FAN_MONITOR_FAULT 0x302c
#define ID_THERMISTOR_FAULT 0x302d
#define ID_EXTERNAL_COMMS_FAULT 0x302e
#define ID_REDUNDANT_PSU_FAULT 0x302f
#define ID_HV_ISOLATION_FAULT 0x3030
#define ID_INPUT_PSU_FAULT 0x3031
#define ID_CHARGE_LIMIT_ENFORCE_FAULT 0x3032
#define ID_PACK_TEMP_FAULT 0x3033
#define ID_PACK_TEMP_EXCEEDED_FAULT 0x3034
#define ID_MIN_PACK_TEMP_FAULT 0x3035
#define ID_IMD_FAULT 0x3036
#define ID_TEST_FAULT_1_FAULT 0x4037
#define ID_TEST_FAULT_2_FAULT 0x4038
#define ID_TEST_FAULT_3_FAULT 0x4039
#define ID_TEST_FAULT_4_FAULT 0x403a
//END AUTO ID DEFS
...
#define PDU_PUMP_1_AUTO_SWITCH_PRIORITY 2
#define PDU_PUMP_2_AUTO_SWITCH_PRIORITY 2
#define PDU_SDC_AUTO_SWITCH_PRIORITY 2
#define PDU_AUX_AUTO_SWITCH_PRIORITY 2
#define PDU_FAN_1_AUTO_SWITCH_PRIORITY 2
#define PDU_FAN_2_AUTO_SWITCH_PRIORITY 2
#define PDU_BLT_AUTO_SWITCH_PRIORITY 2
#define PDU_CRIT_5V_AUTO_SWITCH_PRIORITY 2
#define PDU_NCRIT_5V_AUTO_SWITCH_PRIORITY 2
#define PDU_DAQ_AUTO_SWITCH_PRIORITY 2
#define PDU_FAN_5V_AUTO_SWITCH_PRIORITY 2
...
#define PDU_PUMP_1_AUTO_SWITCH_MAX 1
#define PDU_PUMP_2_AUTO_SWITCH_MAX 1
#define PDU_SDC_AUTO_SWITCH_MAX 1
#define PDU_AUX_AUTO_SWITCH_MAX 1
#define PDU_FAN_1_AUTO_SWITCH_MAX 1
#define PDU_FAN_2_AUTO_SWITCH_MAX 1
#define PDU_BLT_AUTO_SWITCH_MAX 1
#define PDU_CRIT_5V_AUTO_SWITCH_MAX 1
#define PDU_NCRIT_5V_AUTO_SWITCH_MAX 1
#define PDU_DAQ_AUTO_SWITCH_MAX 1
#define PDU_FAN_5V_AUTO_SWITCH_MAX 1
...
#define PDU_PUMP_1_AUTO_SWITCH_MIN 0
#define PDU_PUMP_2_AUTO_SWITCH_MIN 0
#define PDU_SDC_AUTO_SWITCH_MIN 0
#define PDU_AUX_AUTO_SWITCH_MIN 0
#define PDU_FAN_1_AUTO_SWITCH_MIN 0
#define PDU_FAN_2_AUTO_SWITCH_MIN 0
#define PDU_BLT_AUTO_SWITCH_MIN 0
#define PDU_CRIT_5V_AUTO_SWITCH_MIN 0
#define PDU_NCRIT_5V_AUTO_SWITCH_MIN 0
#define PDU_DAQ_AUTO_SWITCH_MIN 0
#define PDU_FAN_5V_AUTO_SWITCH_MIN 0
...
#define PDU_PUMP_1_AUTO_SWITCH_LATCH_TIME 0
#define PDU_PUMP_2_AUTO_SWITCH_LATCH_TIME 0
#define PDU_SDC_AUTO_SWITCH_LATCH_TIME 0
#define PDU_AUX_AUTO_SWITCH_LATCH_TIME 0
#define PDU_FAN_1_AUTO_SWITCH_LATCH_TIME 0
#define PDU_FAN_2_AUTO_SWITCH_LATCH_TIME 0
#define PDU_BLT_AUTO_SWITCH_LATCH_TIME 0
#define PDU_CRIT_5V_AUTO_SWITCH_LATCH_TIME 0
#define PDU_NCRIT_5V_AUTO_SWITCH_LATCH_TIME 0
#define PDU_DAQ_AUTO_SWITCH_LATCH_TIME 0
#define PDU_FAN_5V_AUTO_SWITCH_LATCH_TIME 0
...
#define PDU_PUMP_1_AUTO_SWITCH_UNLATCH_TIME 0
#define PDU_PUMP_2_AUTO_SWITCH_UNLATCH_TIME 0
#define PDU_SDC_AUTO_SWITCH_UNLATCH_TIME 0
#define PDU_AUX_AUTO_SWITCH_UNLATCH_TIME 0
#define PDU_FAN_1_AUTO_SWITCH_UNLATCH_TIME 0
#define PDU_FAN_2_AUTO_SWITCH_UNLATCH_TIME 0
#define PDU_BLT_AUTO_SWITCH_UNLATCH_TIME 0
#define PDU_CRIT_5V_AUTO_SWITCH_UNLATCH_TIME 0
#define PDU_NCRIT_5V_AUTO_SWITCH_UNLATCH_TIME 0
#define PDU_DAQ_AUTO_SWITCH_UNLATCH_TIME 0
#define PDU_FAN_5V_AUTO_SWITCH_UNLATCH_TIME 0
...
#define PDU_PUMP_1_AUTO_SWITCH_MSG "PDU PUMP 1 AUTO SWITCH FAILURE\0" 
#define PDU_PUMP_2_AUTO_SWITCH_MSG "PDU PUMP 2 AUTO SWITCH FAILURE\0" 
#define PDU_SDC_AUTO_SWITCH_MSG "PDU SDC AUTO SWITCH FAILURE\0" 
#define PDU_AUX_AUTO_SWITCH_MSG "PDU AUX AUTO SWITCH FAILURE\0" 
#define PDU_FAN_1_AUTO_SWITCH_MSG "PDU FAN 1 AUTO SWITCH FAILURE\0" 
#define PDU_FAN_2_AUTO_SWITCH_MSG "PDU FAN 2 AUTO SWITCH FAILURE\0" 
#define PDU_BLT_AUTO_SWITCH_MSG "PDU BLT AUTO SWITCH FAILURE\0" 
#define PDU_CRIT_5V_AUTO_SWITCH_MSG "PDU CRIT 5V AUTO SWITCH FAILURE\0" 
#define PDU_NCRIT_5V_AUTO_SWITCH_MSG "PDU NCRIT 5V AUTO SWITCH FAILURE\0" 
#define PDU_DAQ_AUTO_SWITCH_MSG "PDU DAQ AUTO SWITCH FAILURE\0" 
#define PDU_FAN_5V_AUTO_SWITCH_MSG "PDU FAN 5V AUTO SWITCH FAILURE\0" 
