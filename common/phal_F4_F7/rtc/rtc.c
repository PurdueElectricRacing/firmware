...
uint8_t PHAL_configureRTC(RTC_timestamp_t* initial_time)
{
    ...
    RTC->DR |= (yearUnits << RTC_DR_YU_Pos) & RTC_DR_YU_Msk;
    RTC->DR |= (yearTens << RTC_DR_YT_Pos) & RTC_DR_YT_Msk;
    RTC->DR |= (initial_time->date.weekday << RTC_DR_WDU_Pos) & RTC_DR_WDU_Msk;
    RTC->DR |= (monthUnits << RTC_DR_MU_Pos) & RTC_DR_MU_Msk;
    RTC->DR |= (monthTens << RTC_DR_MT_Pos) & RTC_DR_MT_Msk;
    RTC->DR |= (dayUnits << RTC_DR_DU_Pos) & RTC_DR_DU_Msk;
    RTC->DR |= (dayTens << RTC_DR_DT_Pos) & RTC_DR_DT_Msk;
    ...
    RTC->TR |= (RTC_FORMAT_24_HOUR << RTC_TR_PM_Pos) & RTC_TR_PM_Msk;
    RTC->TR |= (hoursUnits << RTC_TR_HU_Pos) & RTC_TR_HU_Msk;
    RTC->TR |= (hoursTens << RTC_TR_HT_Pos) & RTC_TR_HT_Msk;
    RTC->TR |= (minutesUnits << RTC_TR_MNU_Pos) & RTC_TR_MNU_Msk;
    RTC->TR |= (minutesTens << RTC_TR_MNT_Pos) & RTC_TR_MNT_Msk;
    RTC->TR |= (secondsUnits << RTC_TR_SU_Pos) & RTC_TR_SU_Msk;
    RTC->TR |= (secondsTens << RTC_TR_ST_Pos) & RTC_TR_ST_Msk;
...
void PHAL_getTimeRTC(RTC_timestamp_t *currentTimestamp) {
