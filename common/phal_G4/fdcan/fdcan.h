...
#define AF_NUM_FDCAN1           (11)
#define AF_NUM_FDCAN2           (9)
#define AF_NUM_FDCAN13          (11)

// FDCAN1 pin configurations
...
#define GPIO_INIT_FDCAN1TX_PA12 GPIO_INIT_AF(GPIOA, 12, AF_NUM_FDCAN1, GPIO_OUTPUT_ULTRA_SPEED, GPIO_OUTPUT_PUSH_PULL, GPIO_INPUT_OPEN_DRAIN)

// FDCAN2 pin configurations
