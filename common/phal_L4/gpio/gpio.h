...
#define GPIO_INIT_I2C1_SCL_PA9 \
    GPIO_INIT_AF(GPIOA, 9, 4, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_UP)
#define GPIO_INIT_I2C1_SDA_PA10 \
    GPIO_INIT_AF(GPIOA, 10, 4, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_UP)
#define GPIO_INIT_I2C1_SCL_PB6 \
    GPIO_INIT_AF(GPIOB, 6, 4, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_UP)
#define GPIO_INIT_I2C1_SDA_PB7 \
    GPIO_INIT_AF(GPIOB, 7, 4, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_UP)
#define GPIO_INIT_I2C3_SCL_PA7 \
    GPIO_INIT_AF(GPIOA, 7, 4, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_UP)
#define GPIO_INIT_I2C3_SDA_PB4 \
    GPIO_INIT_AF(GPIOB, 4, 4, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_UP)
#define GPIO_INIT_I2C4_SCL_PB10 \
    GPIO_INIT_AF(GPIOB, 10, 4, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_UP)
#define GPIO_INIT_I2C4_SDA_PB11 \
    GPIO_INIT_AF(GPIOB, 11, 4, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_UP)
...
#define GPIO_INIT_SPI1_MISO_PB4 \
...
#define GPIO_INIT_SPI2_SCK_PB10 \
    GPIO_INIT_AF(GPIOB, 10, 5, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_PUSH_PULL, GPIO_INPUT_PULL_DOWN)
...
#define GPIO_INIT_SPI1_SCK_PE13 \
    GPIO_INIT_AF(GPIOE, 13, 5, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_PUSH_PULL, GPIO_INPUT_PULL_DOWN)
#define GPIO_INIT_SPI1_MISO_PE14 \
    GPIO_INIT_AF(GPIOE, 14, 5, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_OPEN_DRAIN)
#define GPIO_INIT_SPI1_MOSI_PE15 \
    GPIO_INIT_AF(GPIOE, 15, 5, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_PUSH_PULL, GPIO_INPUT_PULL_DOWN)
