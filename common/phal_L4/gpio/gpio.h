...
#define GPIO_INIT_I2C3_SCL_PA7 GPIO_INIT_AF(GPIOA, 7, 4, GPIO_OUTPUT_ULTRA_SPEED, GPIO_TYPE_OUTPUT, GPIO_INPUT_PULL_UP)
#define GPIO_INIT_I2C3_SDA_PB4 GPIO_INIT_AF(GPIOB, 4, 4, GPIO_OUTPUT_ULTRA_SPEED, GPIO_TYPE_OUTPUT, GPIO_INPUT_PULL_UP)
