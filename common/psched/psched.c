...
void schedInit(uint32_t freq) {
    ...
    */
    ...
    if (RCC->CFGR & RCC_CFGR_PPRE1_2)
        freq *= 2; // RM0394 pg 188 (timer clock doubles if apb1 prescaler != 0)
...
#if (defined(STM32F407xx) || defined(STM32F732xx) || defined(STM32L432xx) || defined(STM32L471xx) || defined(STM32L496xx))
...
// @funcname: TIM7_IRQHandler() / TIM7_DAC_IRQHandler()
//
// @brief: Timer 7 IRQ. Increments OS ticks and unblocks loop
//         On G4, this is combined with DAC, so we define both names
