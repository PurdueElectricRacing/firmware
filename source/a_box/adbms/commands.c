...
// Read cell voltage result registers
...
// Read average cell voltage result registers
...
const uint8_t STCOMM[13] =
    {0x07, 0x23, 0xB9, 0xE4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
