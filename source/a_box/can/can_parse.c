...
bool initCANFilter()
{
    ...
    CAN1->sFilterRegister[2].FR2 = (ID_FAULT_SYNC_PDU << 3) | 4;
    ...
    CAN1->sFilterRegister[4].FR2 = (ID_FAULT_SYNC_RHENIUM << 3) | 4;
    ...
    CAN1->sFilterRegister[6].FR2 = (ID_DAQ_COMMAND_A_BOX << 3) | 4;
    /* END AUTO FILTER */
