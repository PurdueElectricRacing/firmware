...
#define ID_NUM_THERM_BAD_A_B_C 0x100080c4
#define ID_NUM_THERM_BAD_D_E 0x10008344
...
#define DLC_NUM_THERM_BAD_A_B_C 3
#define DLC_NUM_THERM_BAD_D_E 2
...
#define SEND_NUM_THERM_BAD_A_B_C(A_, B_, C_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN1, .ExtId=ID_NUM_THERM_BAD_A_B_C, .DLC=DLC_NUM_THERM_BAD_A_B_C, .IDE=1};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
        data_a->num_therm_bad_a_b_c.A = A_;\
        data_a->num_therm_bad_a_b_c.B = B_;\
        data_a->num_therm_bad_a_b_c.C = C_;\
        canTxSendToBack(&msg);\
    } while(0)
#define SEND_NUM_THERM_BAD_D_E(D_, E_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN1, .ExtId=ID_NUM_THERM_BAD_D_E, .DLC=DLC_NUM_THERM_BAD_D_E, .IDE=1};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
        data_a->num_therm_bad_d_e.D = D_;\
        data_a->num_therm_bad_d_e.E = E_;\
        canTxSendToBack(&msg);\
    } while(0)
