...
GPIOInitConfig_t gpio_config[] = {
   ...
   //GPIO_INIT_INPUT(IMD_LS_PWM_GPIO_Port, IMD_LS_PWM_Pin, GPIO_INPUT_OPEN_DRAIN),
   //GPIO_INIT_AF(IMD_HS_PWM_GPIO_Port, IMD_HS_PWM_Pin, IMD_HS_PWM_AF, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_DOWN),
   //GPIO_INIT_AF(IMD_LS_PWM_GPIO_Port, IMD_LS_PWM_Pin, IMD_LS_PWM_AF, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_DOWN), // DETERMINE which bender model
   // MHS (for IRI55-3204) or MLS (for IR155-3203).
   GPIO_INIT_AF(IMD_LS_PWM_GPIO_Port, IMD_LS_PWM_Pin, IMD_LS_PWM_AF, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_DOWN),
   //GPIO_INIT_AF(IMD_STATUS_GPIO_Port, IMD_STATUS_Pin, IMD_STATUS_AF, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_DOWN),
