...
bool orionErrors() {
    ...
    setFault(ID_DISCHARGE_LIMIT_ENFORCE_FAULT,
             can_data.orion_errors.discharge_limit_enforce | can_data.orion_errors_charger.discharge_limit_enforce);
    setFault(ID_CHARGER_SAFETY_RELAY_FAULT,
             can_data.orion_errors.charger_safety_relay | can_data.orion_errors_charger.charger_safety_relay);
    setFault(ID_INTERNAL_HARDWARE_FAULT,
             can_data.orion_errors.internal_hardware | can_data.orion_errors_charger.internal_hardware);
    setFault(ID_HEATSINK_THERMISTOR_FAULT,
             can_data.orion_errors.heatsink_thermistor | can_data.orion_errors_charger.heatsink_thermistor);
    setFault(ID_SOFTWARE_FAULT, can_data.orion_errors.software | can_data.orion_errors_charger.software);
    setFault(ID_MAX_CELLV_HIGH_FAULT,
             can_data.orion_errors.max_cellv_high | can_data.orion_errors_charger.max_cellv_high);
    setFault(ID_MIN_CELLV_LOW_FAULT, can_data.orion_errors.min_cellv_low | can_data.orion_errors_charger.min_cellv_low);
    setFault(ID_PACK_OVERHEAT_ORION_FAULT,
             can_data.orion_errors.pack_overheat | can_data.orion_errors_charger.pack_overheat);
    setFault(ID_INTERNAL_COMMS_FAULT,
             can_data.orion_errors.internal_comms | can_data.orion_errors_charger.internal_comms);
    setFault(ID_CELL_BALANCING_FOFF_FAULT,
             can_data.orion_errors.cell_balancing_foff | can_data.orion_errors_charger.cell_balancing_foff);
    ...
    setFault(ID_CURRENT_SENSOR_FAULT,
             can_data.orion_errors.current_sensor | can_data.orion_errors_charger.current_sensor);
    ...
    setFault(ID_EXTERNAL_COMMS_FAULT,
             can_data.orion_errors.external_comms | can_data.orion_errors_charger.external_comms);
    ...
    setFault(ID_CHARGE_LIMIT_ENFORCE_FAULT,
             can_data.orion_errors.charge_limit_enforce | can_data.orion_errors_charger.charge_limit_enforce);
