...
typedef enum
{
    ...
    BLSTAT_WAIT = 2,        /* Stage 1: RST done, waiting for BLCMD */
    BLSTAT_METDATA_RX = 3,  /* Stage 2: Flash erase done */
    BLSTAT_PROGRESS = 4,    /* Progress update for bootloader download */
    BLSTAT_DONE = 5,        /* Stage 3: Completed firmware transfer with CRC checksum */
