...
bool initCANFilter()
{
    ...
    CAN1->sFilterRegister[8].FR2 = (ID_FAULT_SYNC_PDU << 3) | 4;
    CAN1->FA1R |= (1 << 9);    // configure bank 9
    CAN1->sFilterRegister[9].FR1 = (ID_FAULT_SYNC_MAIN_MODULE << 3) | 4;
    CAN1->sFilterRegister[9].FR2 = (ID_FAULT_SYNC_A_BOX << 3) | 4;
    CAN1->FA1R |= (1 << 10);    // configure bank 10
    CAN1->sFilterRegister[10].FR1 = (ID_FAULT_SYNC_TORQUE_VECTOR << 3) | 4;
    CAN1->sFilterRegister[10].FR2 = (ID_FAULT_SYNC_TEST_NODE << 3) | 4;
    CAN1->FA1R |= (1 << 11);    // configure bank 11
    CAN1->sFilterRegister[11].FR1 = (ID_SET_FAULT << 3) | 4;
    CAN1->sFilterRegister[11].FR2 = (ID_RETURN_FAULT_CONTROL << 3) | 4;
