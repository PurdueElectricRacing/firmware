...
#define SEND_DASHBOARD_TV_PARAMETERS(vcu_fmode_, vcu_cmode_, vt_db_val_, tv_pp_val_, tc_tr_val_, vs_max_sr_val_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN1, .ExtId=ID_DASHBOARD_TV_PARAMETERS, .DLC=DLC_DASHBOARD_TV_PARAMETERS, .IDE=1};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
        data_a->dashboard_tv_parameters.vcu_fmode = vcu_fmode_;\
        data_a->dashboard_tv_parameters.vcu_cmode = vcu_cmode_;\
        data_a->dashboard_tv_parameters.vt_db_val = vt_db_val_;\
        data_a->dashboard_tv_parameters.tv_pp_val = tv_pp_val_;\
        data_a->dashboard_tv_parameters.tc_tr_val = tc_tr_val_;\
        data_a->dashboard_tv_parameters.vs_max_sr_val = vs_max_sr_val_;\
        canTxSendToBack(&msg);\
    } while(0)
