...
uint8_t fault_time_displayed;         // Amount of time units that the fault has been shown to the driver

// Call initially to ensure the LCD is initialized
...
// Periodically send TV config to TV board
