...
const page_handler_t page_handlers[] = {
    ...
    [PAGE_RACE] = {racePageUpdate,
                   raceUpCallback,
                   raceDownCallback,
                   raceSelect,
                   raceTelemetryUpdate}, // No move handlers, telemetry is passive
...
menu_element_t race_elements[] = {
    {.type = ELEMENT_OPTION, .object_name = RACE_TV_ON, .current_value = 0, .on_change = sendTVParameters}};

menu_page_t race_page = {.elements = race_elements,
...
menu_element_t cooling_elements[] = {[COOLING_DT_FAN_INDEX] = {.type = ELEMENT_VAL,
                                     ...
                                     [COOLING_DT_PUMP_INDEX] = {.type = ELEMENT_OPTION,
                                                                .object_name = DT_PUMP_OP,
                                                                .current_value = 0,
                                                                .on_change = sendCoolingParameters},
                                     [COOLING_B_FAN_INDEX] = {.type = ELEMENT_VAL,
                                                              ...
                                                              .increment = 25,
                                                              .on_change = sendCoolingParameters},
                                     [COOLING_B_PUMP_INDEX] = {.type = ELEMENT_OPTION,
                                                               .object_name = B_PUMP_OP,
                                                               .current_value = 0,
                                                               .on_change = sendCoolingParameters}};

menu_page_t cooling_page = {.elements = cooling_elements,
...
menu_element_t tv_elements[] = {[TV_VCU_PERMIT_INDEX] =
                                ...
                                [TV_VCU_CONTROL_INDEX] =
                                    {// Not using the OPTION type here to display the text instead of the value
                                     ...
                                     .increment = 1,
                                     .on_change = sendTVParameters},
                                [TV_DEADBAND_INDEX] = {.type = ELEMENT_VAL,
                                                       ...
                                                       .on_change = sendTVParameters},
                                [TV_P_GAIN_INDEX] = {.type = ELEMENT_FLT,
                                                     ...
                                                     .on_change = sendTVParameters},
                                [TV_TORQUE_DROP_INDEX] = {.type = ELEMENT_FLT,
                                                          ...
                                                          .on_change = sendTVParameters},
                                [TV_MAX_SLIP_INDEX] = {.type = ELEMENT_FLT,
...
menu_page_t tv_page = {.elements = tv_elements,
                       .num_elements = sizeof(tv_elements) / sizeof(tv_elements[0]),
                       .current_index = 0,
                       .is_element_selected = false};

menu_element_t faults_elements[] = {[0] =
                                        {
                                            .type = ELEMENT_BUTTON,
...
menu_page_t faults_page = {.elements = faults_elements,
                           .num_elements = sizeof(faults_elements) / sizeof(faults_elements[0]),
                           .current_index = 0,
                           .is_element_selected = false};

menu_element_t driver_elements[] = {[0] =
                                        {
                                            .type = ELEMENT_LIST,
...
menu_page_t driver_page = {.elements = driver_elements,
...
menu_element_t pedal_profile_elements[] = {[PROFILE_BRAKE_INDEX] =
                                           ...
                                           [PROFILE_SAVE_INDEX] = {.type = ELEMENT_BUTTON,
...
menu_page_t logging_page = {.elements = logging_elements,
...
void sendTVParameters() {
    SEND_DASHBOARD_VCU_PARAMETERS(tv_elements[TV_VCU_PERMIT_INDEX].current_value,
...
void raceTelemetryUpdate() {
    ...
    if (can_data.INVA_CRIT.stale && can_data.INVA_CRIT.stale) {
        ...
        uint16_t motor_overload =
            MAX(can_data.INVA_CRIT.AMK_DisplayOverloadMotor, can_data.INVB_CRIT.AMK_DisplayOverloadMotor) * 10;
