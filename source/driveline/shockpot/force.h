...
#define DELTA_REAR   0.001       // sampling rate of the microcontoller, s
...
#define DELTA_FRONT   0.001       // sampling rate of the microcontoller, s
...
#define RESOLUTION_REAR  0.0008097  // convert ADC value to real numbers, resolution of the ADC, 
#define ZERO_REAR        -1   // actual displacement when ADC shows 0, in  
