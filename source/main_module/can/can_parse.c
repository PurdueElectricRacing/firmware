...
bool initCANFilter()
{
    ...
    CAN1->sFilterRegister[14].FR1 = (ID_INVA_CRIT << 21);
    CAN1->sFilterRegister[14].FR2 = (ID_INVA_INFO << 21);
    CAN1->FA1R |= (1 << 15);    // configure bank 15
    CAN1->sFilterRegister[15].FR1 = (ID_INVA_TEMPS << 21);
    CAN1->sFilterRegister[15].FR2 = (ID_INVA_SET << 21);
    CAN1->FA1R |= (1 << 16);    // configure bank 16
    CAN1->sFilterRegister[16].FR1 = (ID_INVA_ERR_1 << 21);
    CAN1->sFilterRegister[16].FR2 = (ID_INVA_ERR_2 << 21);
    CAN1->FA1R |= (1 << 17);    // configure bank 17
    CAN1->sFilterRegister[17].FR1 = (ID_INVB_CRIT << 21);
    CAN1->sFilterRegister[17].FR2 = (ID_INVB_INFO << 21);
    CAN1->FA1R |= (1 << 18);    // configure bank 18
    CAN1->sFilterRegister[18].FR1 = (ID_INVB_TEMPS << 21);
    CAN1->sFilterRegister[18].FR2 = (ID_INVB_SET << 21);
    CAN1->FA1R |= (1 << 19);    // configure bank 19
    CAN1->sFilterRegister[19].FR1 = (ID_INVB_ERR_1 << 21);
    CAN1->sFilterRegister[19].FR2 = (ID_INVB_ERR_2 << 21);
