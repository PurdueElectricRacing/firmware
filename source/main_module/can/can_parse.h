...
/* BEGIN AUTO ID DEFS */
#define ID_MAIN_HB_AMK 0xa800000
#define ID_INVA_SET 0x188
#define ID_INVB_SET 0x189
#define ID_MAIN_HB 0x8c00000
#define ID_COOLANT_TEMPS 0x8c00200
#define ID_GEARBOX 0x8c00400
#define ID_LWS_CONFIG 0x7c0
#define ID_LOAD_SENSOR_READINGS 0x8c00800
#define ID_SHOCK_REAR 0x8c00a00
#define ID_MCU_STATUS 0x8c00c00
#define ID_MAIN_MODULE_CAN_STATS 0x8c00e00
#define ID_NUM_MC_SKIPS 0x8c01000
#define ID_INVA_LOG_SET 0x8c01200
#define ID_INVB_LOG_SET 0x8c01400
#define ID_REAR_MC_STATUS 0x8c01600
#define ID_REAR_MOTOR_CURRENTS_VOLTS 0x8c01800
#define ID_SDC_STATUS 0x8c01a00
#define ID_REAR_MOTOR_TEMPS 0x8c01c00
#define ID_REAR_WHEEL_SPEEDS 0x8c01e00
#define ID_SIMULATED_TV 0x8c02000
#define ID_FAULT_SYNC_MAIN_MODULE 0xc02200
#define ID_DAQ_RESPONSE_MAIN_MODULE_VCAN 0x8c02400
...
#define ID_RAW_THROTTLE_BRAKE 0x8a00000
#define ID_FILT_THROTTLE_BRAKE 0x8a00800
#define ID_START_BUTTON 0x8a00a00
...
#define ID_VCU_TORQUES_SPEEDS 0x8400e00
#define ID_DRIVE_MODES 0x8401200
...
#define ID_DAQ_COMMAND_MAIN_MODULE_VCAN 0x9800000
/* END AUTO ID DEFS */
...
#define DLC_DAQ_COMMAND_MAIN_MODULE_VCAN 8
/* END AUTO DLC DEFS */
...
#define SEND_INVA_SET(AMK_Control_bReserve_, AMK_Control_bInverterOn_, AMK_Control_bDcOn_, AMK_Control_bEnable_, AMK_Control_bErrorReset_, AMK_Control_bReserve2_, AMK_TorqueSetpoint_, AMK_PositiveTorqueLimit_, AMK_NegativeTorqueLimit_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN2, .StdId=ID_INVA_SET, .DLC=DLC_INVA_SET, .IDE=0};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
...
#define SEND_INVB_SET(AMK_Control_bReserve_, AMK_Control_bInverterOn_, AMK_Control_bDcOn_, AMK_Control_bEnable_, AMK_Control_bErrorReset_, AMK_Control_bReserve2_, AMK_TorqueSetpoint_, AMK_PositiveTorqueLimit_, AMK_NegativeTorqueLimit_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN2, .StdId=ID_INVB_SET, .DLC=DLC_INVB_SET, .IDE=0};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
...
#define SEND_SIMULATED_TV(left_tv_, right_tv_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN1, .ExtId=ID_SIMULATED_TV, .DLC=DLC_SIMULATED_TV, .IDE=1};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
...
#define SEND_DAQ_RESPONSE_MAIN_MODULE_VCAN(daq_response_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN1, .ExtId=ID_DAQ_RESPONSE_MAIN_MODULE_VCAN, .DLC=DLC_DAQ_RESPONSE_MAIN_MODULE_VCAN, .IDE=1};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
...
extern void daq_command_MAIN_MODULE_VCAN_CALLBACK(CanMsgTypeDef_t* msg_header_a);
