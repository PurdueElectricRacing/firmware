...
// Thread Defines
DEFINE_CAN_TASKS();
DEFINE_TASK(vehicle_fsm_periodic, VEHICLE_FSM_PERIOD_MS, TASK_PRIORITY_NORMAL, STACK_2048);
DEFINE_TASK(fault_library_periodic, MAIN_MODULE_FAULT_SYNC_PERIOD_MS, TASK_PRIORITY_NORMAL, STACK_1024);
DEFINE_TASK(SDC_task_periodic, SDC_TASK_PERIOD_MS, TASK_PRIORITY_NORMAL, STACK_512);
DEFINE_TASK(report_telemetry_50hz, TELEMETRY_50HZ_PERIOD_MS, TASK_PRIORITY_LOW, STACK_512);
DEFINE_TASK(report_telemetry_1hz, TELEMETRY_1HZ_PERIOD_MS, TASK_PRIORITY_LOW, STACK_512);
