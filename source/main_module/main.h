...
// todo check on this pin it was 6 before
...
#define THERM_MUX_OUT_GPIO_Port (GPIOC)
#define THERM_MUX_OUT_Pin       (0)
#define THERM_MUX_OUT_ADC_CHNL  (10)
