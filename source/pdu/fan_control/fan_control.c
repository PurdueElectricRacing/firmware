...
bool fanControlInit()
{
    ...
    /* Enable power to both of the fans */
    PHAL_writeGPIO(FAN_1_CTRL_GPIO_Port, FAN_1_CTRL_Pin, 1);
    PHAL_writeGPIO(FAN_2_CTRL_GPIO_Port, FAN_2_CTRL_Pin, 1);
    ...
    */
    ...
    // Set PWM od 1 (active while CNT <= CCR1)
