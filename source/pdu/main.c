...
dma_init_t adc_dma_config =
    ADC1_DMA_CONT_CONFIG((uint32_t)&adc_readings, sizeof(adc_readings) / sizeof(adc_readings.lv_24_v_sense), 0b01);
...
void send_iv_readings() {
    ...
    SEND_V_RAILS(auto_switches.voltage.in_24v,
    ...
    SEND_PUMP_AND_FAN_CURRENT(auto_switches.current[SW_PUMP_1],
                              auto_switches.current[SW_PUMP_2],
                              auto_switches.current[SW_FAN_1],
                              auto_switches.current[SW_FAN_2]);
    SEND_OTHER_CURRENTS(auto_switches.current[SW_SDC],
                        auto_switches.current[SW_AUX],
