...
/**
* @brief Handles the interrupt generated by TIM3. This will read the current value on GPIOB pin 5
*        and add its value to the corresponding array (mhs_frequency[])
*/
...
/**
* @brief Handles the interrupt generated by TIM4. This will read the current value on GPIOB pin 6
*        and add its value to the corresponding array (mls_frequency[])
*/
