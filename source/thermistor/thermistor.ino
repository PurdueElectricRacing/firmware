...
void setup()
{
	...
	pinMode(ADC_MUX_SIG_0_PIN, 	INPUT_PULLUP);
	pinMode(ADC_MUX_SIG_1_PIN, 	INPUT_PULLUP);
	pinMode(ADC_MUX_SIG_2_PIN, 	INPUT_PULLUP);
	pinMode(ADC_MUX_SIG_3_PIN, 	INPUT_PULLUP);
...
void loop()
{
	...
	// MUX decoding
	digitalWrite(ADC_MUX_SIG_0_PIN, (mux_index & 0b0001) == 0b0001);
	digitalWrite(ADC_MUX_SIG_1_PIN, (mux_index & 0b0010) == 0b0010);
	digitalWrite(ADC_MUX_SIG_2_PIN, (mux_index & 0b0100) == 0b0100);
	digitalWrite(ADC_MUX_SIG_3_PIN, (mux_index & 0b1000) == 0b1000);
