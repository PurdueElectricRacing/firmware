...
#define BSXLITE_E_DOSTEPS_TSINTRADIFFOUTOFRANGE \
    (-5) /** Difference of time stamps between subsequent doSteps calls is out of range. */
 ...
 */
bsxlite_return_t bsxlite_do_step(const bsxlite_instance_t* instance_p,
                                 const int32_t w_time_stamp,
                                 const vector_3d_t* accel_in_p,
                                 const vector_3d_t* gyro_in_p,
                                 bsxlite_out_t* output_data_p);
