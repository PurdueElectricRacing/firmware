...
// Thread Defines
DEFINE_CAN_TASKS();
DEFINE_TASK(control_loop, CONTROL_LOOP_PERIOD_MS, TASK_PRIORITY_NORMAL, STACK_4096);
DEFINE_TASK(gps_periodic, GPS_THREAD_PERIOD_MS, TASK_PRIORITY_LOW, STACK_1024);
DEFINE_TASK(report_telemetry_25hz, TELEMETRY_25HZ_PERIOD_MS, TASK_PRIORITY_LOW, STACK_512);
