...
GPIOInitConfig_t gpio_config[] = {
    ...
    /* IMU */
    GPIO_INIT_AF(SPI_SCLK_GPIO_Port,
                 SPI_SCLK_Pin,
                 5,
                 GPIO_OUTPUT_HIGH_SPEED,
                 GPIO_OUTPUT_PUSH_PULL,
                 GPIO_INPUT_PULL_DOWN),
    GPIO_INIT_AF(SPI_MOSI_GPIO_Port,
                 SPI_MOSI_Pin,
                 5,
                 GPIO_OUTPUT_HIGH_SPEED,
                 GPIO_OUTPUT_PUSH_PULL,
                 GPIO_INPUT_PULL_DOWN),
    GPIO_INIT_AF(SPI_MISO_GPIO_Port,
                 SPI_MISO_Pin,
                 5,
                 GPIO_OUTPUT_HIGH_SPEED,
...
usart_init_t huart_gps = {.baud_rate = 115200,
                          .word_length = WORD_8,
...
usart_init_t usb = {.baud_rate = 115200,
                    .word_length = WORD_8,
                    .stop_bits = SB_ONE,
                    .parity = PT_NONE,
                    .hw_flow_ctl = HW_DISABLE,
...
SPI_InitConfig_t spi_config = {.data_rate = TargetCoreClockrateHz / 64,
                               .data_len = 8,
                               .nss_sw = true,
...
/* IMU Configuration */
BMI088_Handle_t bmi_config = {.accel_csb_gpio_port = SPI_CS_ACEL_GPIO_Port,
...
void VCU_MAIN(void) {
    ...
    SEND_VCU_TORQUES_SPEEDS((int16_t)(100 * yVCU.TO_VT[0]),
                            (int16_t)(100 * yVCU.TO_VT[1]),
                            (int16_t)(100 * yVCU.TO_PT[0]),
                            (int8_t)(yVCU.VCU_mode));
