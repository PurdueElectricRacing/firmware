...
GPIOInitConfig_t gpio_config[] = {
    ...
    // EEPROM SPI3
    GPIO_INIT_AF(EEPROM_SPI_SCK_GPIO_PORT, EEPROM_SPI_SCK_PIN, 6, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_PUSH_PULL, GPIO_INPUT_PULL_DOWN),
    GPIO_INIT_AF(EEPROM_SPI_MISO_GPIO_PORT, EEPROM_SPI_MISO_PIN, 6, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_PUSH_PULL, GPIO_INPUT_PULL_DOWN),
    GPIO_INIT_AF(EEPROM_SPI_MOSI_GPIO_PORT, EEPROM_SPI_MOSI_PIN, 6, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_OPEN_DRAIN),
    GPIO_INIT_OUTPUT(EEPROM_NSS_GPIO_PORT, EEPROM_NSS_PIN, GPIO_OUTPUT_HIGH_SPEED),
...
void txUsart()
{
    ...
    memcpy(txmsg.WM_CS, yVCU.WM_CS, sizeof(txmsg.WM_CS));
