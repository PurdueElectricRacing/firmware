...
void vcu_pp(xVCU_struct *xVCU, fVCU_struct *fVCU, GPS_Handle_t *GPS)
{
    ...
    xVCU->WM_RAW[1] = (can_data.actual_torque_speed.speed_left); /*Incoming is rad/s of motor shaft */
    xVCU->WM_RAW[2] = (can_data.actual_torque_speed.speed_right); /*Incoming is rad/s of motor shaft */
    ...
    xVCU->MC_RAW = (MAX((can_data.INV_Overload.AMK_DisplayOverloadMotorA),(can_data.INV_Overload.AMK_DisplayOverloadMotorB))*0.01); /* incoming data is 100*% */
    xVCU->IC_RAW = (MAX((can_data.INV_Overload.AMK_DisplayOverloadInverterA),(can_data.INV_Overload.AMK_DisplayOverloadInverterB))*0.01); /* incoming data is 100*% */
    ...
    xVCU->TO_RAW[1] = (can_data.actual_torque_speed.torque_left)*0.01; /* incoming data is 100*Nm */
    xVCU->TO_RAW[2] = (can_data.actual_torque_speed.torque_right)*0.01; /* incoming data is 100*Nm */
